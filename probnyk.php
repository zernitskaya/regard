...
<head>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[1]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[1]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[1]->nacenka->old; ?>;
		...
		<div class="main_photo_preview_modal clearfix">
			...
			<div class="main_photo_preview_main_photo_container">
				...
				<div class="main_photo_preview_video_container">
					<div class="photo_preview_video_innner" id="lightbox_video04">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Bb6-SXUXN9c" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video03">
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">AMD Ryzen</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">AMD RYZEN</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер AMD RYZEN</h1>
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
							...
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									<div class="side_mini_photo active">
										<img src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/354.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/352.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/383.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/384.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/409.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/417.jpg">
									</div>
									...
									<div class="side_mini_video" data-video="video04">
										<img src="img/video-preview.png">
									</div>
								</div>
							</div>
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="http://xn--80afeb8cd.com/cases/1/ZalmanZ11/354.jpg" class="main_photo_image">
							<div class="main_video_container">
								<div class="video_innner" id="video04">
									<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Bb6-SXUXN9c" frameborder="0" allowfullscreen></iframe>
								</div>
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">Игровой компьютер AMD RYZEN</h1>
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							<div class="product_page_price_block_outer clearfix">
								<div class="product_page_price_block_outer_text"><a href="super-price.html" class="super_price_title">Суперцена до <span class="super_price_date"><? echo $base->promo->word; ?></span>!
									<div></div>
								</a></div>
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span href="http://www.xn--80afeb8cd.com/amd-ryzen.html" class="comments_num_container">14</span> отзывов</a>
				...
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span href="http://www.xn--80afeb8cd.com/amd-ryzen.html" class="comments_num_container">14</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label recommend" data-price="<? echo $base->corpuses->corpus[8]->price; ?>"><input name="comp" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[14]->price; ?>"><input name="comp" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[22]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/gamemaxx.png">
											<div class="zoom_in_hover photoPopup" modal-id="101">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">GameMax VEGA</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[20]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/versac21.png">
											<div class="zoom_in_hover photoPopup" modal-id="99">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Thermaltake Versa C21 RGB</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[13]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[21]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/versac23.png">
											<div class="zoom_in_hover photoPopup" modal-id="100">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Thermaltake Versa C23</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[23]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/cougar.png">
											<div class="zoom_in_hover photoPopup" modal-id="102">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Cougar Panzer S</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[19]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/mastercase5pro.png">
											<div class="zoom_in_hover photoPopup" modal-id="98">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Cooler Master MasterCase Pro 6 Red LED</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[18]->price; ?>"><input name="comp" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
												<img src="http://xn--80afeb8cd.com/cases/mastercase5t.png">
											<div class="zoom_in_hover photoPopup" modal-id="97">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Cooler Master MasterCase Maker 5t</div>
											<div class="radio_description_text">
												Aerocool Project 7 - сочетает в себе привлекательный дизайн и высокую функциональность. Корпус оснащен сложной системой подсветки, которая состоит из настраиваемой светодиодной вставки, дополняя ощущение, что это роскошный суперкар.
											</div>
											</div>
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/AMD-Ryzen™-5-1400.png">
									</div>
									<div class="tab_labels_container">
										<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[21]->price; ?>" data-short="<? echo $base->processors->cpu[21]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 5 1400 4-Ядра 3.2 - 3.4GHz Turbo, AM4, 65W TDP
											</div>
											<div class="radio_description_text">
												4 ядра, 8 потоков, 8МБ кэш, частота процессора от 3.20ГГц до 3.40ГГц
												AM4, Ryzen 5, Тепловыделение 65Вт, Разблокированный множитель
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[22]->price; ?>" data-short="<? echo $base->processors->cpu[22]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 5 1500X 4-Ядра 3.5 - 3.7GHz Turbo, AM4, 65W TDP</div>
											<div class="radio_description_text">
												4 ядра, 8 потоков, 16МБ кэш, частота процессора от 3.50ГГц до 3.70ГГц
												AM4, Ryzen 5, Тепловыделение 65Вт, Разблокированный множитель
											</div>
											</div>
											<div class="radio_price"></div>
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[23]->price; ?>" data-short="<? echo $base->processors->cpu[23]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 5 1600 6-Ядер 3.2 - 3.6GHz Turbo, AM4, 65W TDP</div>
											<div class="radio_description_text">
												6 ядер, 12 потоков, 16МБ кэш, частота процессора от 3.20ГГц до 3.60ГГц
												AM4, Ryzen 5, Тепловыделение 65Вт, Разблокированный множитель
											</div>
											</div>
											<div class="radio_price"></div>
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[24]->price; ?>" data-short="<? echo $base->processors->cpu[24]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Ryzen™-7-1700.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 7 1700 8-Ядер 3.0 - 3.7GHz Turbo, AM4, 65W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[28]->price; ?>" data-short="<? echo $base->processors->cpu[28]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AMD-Ryzen™-7-1700X.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 7 1700X 8-Ядер 3.4 - 3.8GHz Turbo, AM4, 95W TDP, без кулера</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[29]->price; ?>" data-short="<? echo $base->processors->cpu[29]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Ryzen™ 7 1800X 8-Ядер 3.6 - 4.0GHz Turbo, AM4, 95W TDP, без кулера</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/AMD_Wraith_400.gif">
									</div>
									<div class="new_tab_labels_container">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[6]->price; ?>" data-short="<? echo $base->coolers->cooler[6]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/DeepCool-MAELSTROM-240T.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">DeepCool MAELSTROM 240T</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label><label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[7]->price; ?>" data-short="<? echo $base->coolers->cooler[7]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/DeepCool-MAELSTROM-120.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">DeepCool MAELSTROM 120</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
										<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[10]->price; ?>" data-short="<? echo $base->videocards->videocard[10]->short; ?>" data-title="NVIDIA GeForce GTX 1060 - 3GB (VR-Ready)"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[12]->price; ?>" data-short="<? echo $base->videocards->videocard[12]->short; ?>" data-title="AMD Radeon RX 580 - 8GB (VR-Ready)"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AMD-Radeon-RX-580.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon RX 580 - 8GB (VR-Ready)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<!-- Блок видеокарт -->
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video active" style="display:block">
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[14]->price; ?>" data-short="<? echo $base->videocards->videocard[14]->short; ?>" data-title="NVIDIA GeForce GTX 1070 - 8GB (VR-Ready) x1"><input name="videocard" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[15]->price; ?>" data-short="<? echo $base->videocards->videocard[15]->short; ?>" data-title="NVIDIA GeForce GTX 1070 - 8GB (VR-Ready) SLI"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video ">
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[18]->price; ?>" data-short="<? echo $base->videocards->videocard[18]->short; ?>" data-title="NVIDIA GeForce GTX 1080 - 8GB (GDDR5X) (VR-Ready) x1"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[19]->price; ?>" data-short="<? echo $base->videocards->videocard[19]->short; ?>" data-title="NVIDIA GeForce GTX 1080 - 8GB (GDDR5X) (VR-Ready) SLI"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											<div class="label_dropdown_btn_video">
												...
												<div class="label_dropdown_btn_title">NVIDIA GeForce GTX 1080 Ti - 11GB (VR Ready)</div>
												<div class="label_dropdown_btn_price_video"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
									...
									<div class="tab_labels_container">
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">8 GB [8 GB x1] DDR4-2100</div>
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[4]->price; ?>" data-short="<? echo $base->rams->ram[4]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [8 GB x1] DDR4-2100</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[5]->price; ?>" data-short="<? echo $base->rams->ram[5]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 G.Skill Trident Z RGB"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [8 GB x1] DDR4-2400</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[6]->price; ?>" data-short="<? echo $base->rams->ram[6]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [8 GB x1] DDR4-2400 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[9]->price; ?>" data-short="<? echo $base->rams->ram[9]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 Team T-Force Delta RGB White"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [4 GB x2] DDR4-2400 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">16 GB [8 GB x2] DDR4-21
												00</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[10]->price; ?>" data-short="<? echo $base->rams->ram[10]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">16 GB [8 GB x2] DDR4-2100</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[11]->price; ?>" data-short="<? echo $base->rams->ram[11]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">16 GB [8 GB x2] DDR4-2400</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[13]->price; ?>" data-short="<? echo $base->rams->ram[13]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">32 GB [8 GB x4] DDR4-2400 Kingston HyperX Fury</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[15]->price; ?>" data-short="<? echo $base->rams->ram[15]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">64 GB [16 GB x4] DDR4-2400</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[19]->price; ?>" data-short="<? echo $base->rams->ram[19]->short; ?>" data-title="64 GB [16 GB x4] DDR4-2400 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">64 GB [16 GB x4] DDR4-2400</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[20]->price; ?>" data-short="<? echo $base->rams->ram[20]->short; ?>" data-title="64 GB [16 GB x4] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">64 GB [16 GB x4] DDR4-2400 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[39]->price; ?>" data-short="<? echo $base->rams->ram[39]->short; ?>" data-title="64 GB [16 GB x4] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">64 GB [16 GB x4] DDR4-3000 Kingston HyperX Predator</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[42]->price; ?>" data-short="<? echo $base->rams->ram[42]->short; ?>" data-title="64 GB [16 GB x4] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">64 GB [16 GB x4] DDR4-3000 G.Skill Trident Z RGB</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
							...
							<div class="accordion_block" id="accordion_storage">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[2]->price; ?>" data-short="<? echo $base->hdds->hdd[2]->short; ?>"><input name="hdd" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[3]->price; ?>" data-short="<? echo $base->hdds->hdd[3]->short; ?>"><input name="hdd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label ssd_label big_line_label" data-price="<? echo $base->ssds->ssd[1]->price; ?>" data-short="<? echo $base->ssds->ssd[1]->short; ?>"><input name="ssd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/MSI-B350.png">
									</div>
									<div class="tab_labels_container">
										<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[4]->price; ?>" data-short="<? echo $base->materinkas->materinka[4]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS/MSI B350M PRO-VDH Socket AM4</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[5]->price; ?>" data-short="<? echo $base->materinkas->materinka[5]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/msi-x370.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS/MSI X370 GAMING PLUS Socket AM4</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[18]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[18]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[18]->fps[0]; ?></div>
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[18]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[18]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[18]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[19]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[19]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[19]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[19]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[19]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[19]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[6]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[6]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[6]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[6]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[6]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[6]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[7]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[7]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[7]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[7]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[7]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[7]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[11]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[11]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[11]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[11]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[11]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[11]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[8]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[8]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[8]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[8]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[8]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[8]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[0]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[0]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[0]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[0]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[0]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[0]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[1]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[1]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[1]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[1]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[1]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[1]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[2]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[2]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[2]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[2]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[2]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[2]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[3]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[3]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[3]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[3]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[3]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[3]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[4]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[4]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[4]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[4]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[4]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[4]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[5]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[5]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[5]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[5]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[9]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[9]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[9]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[9]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[9]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[9]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[10]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[10]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[10]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[10]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[10]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[10]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[12]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[12]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[12]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[12]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[12]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[12]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[13]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[13]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[13]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[13]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[13]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[13]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[14]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[14]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[14]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[14]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[14]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[14]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[15]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[15]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[15]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[15]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[15]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[15]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[16]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[16]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[16]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[16]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[16]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[16]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD 1920x1080</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[17]->color[0]; ?>; width:<? echo $base->computers->comp[1]->games->game[17]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[1]->games->game[17]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">4K 3840X2160</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[1]->games->game[17]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[17]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[1]->games->game[17]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>

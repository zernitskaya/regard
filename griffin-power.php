...
<head>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[0]->pp; ?>;
...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">GRIFFIN POWER</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер GRIFFIN POWER</h1>
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
							...
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									<div class="side_mini_photo active">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/334.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/335.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/337.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/342.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/239.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/410.jpg">
									</div>
									<div class="side_mini_photo">
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="http://xn--80afeb8cd.com/cases/1/FrontierWarrior/334.jpg" class="main_photo_image">
						...
						<div class="product_page_flex_price">
							<div class="product_page_price_block_outer clearfix">
								...
								<div class="product_page_price_block clearfix">
									...
									<div class="buy_button buy_button_ololo" onClick="ga('send', 'pageview', '/virtual/kupit');"f><img src="img/basket.png">Купить</div>
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span href="http://www.xn--80afeb8cd.com/griffin-power.html" class="comments_num_container">47</span> отзывов</a>
			...
			<div class="tabs_block">
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span href="http://www.xn--80afeb8cd.com/griffin-power.html" class="comments_num_container">47</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[11]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
2 ядра, 4 потока, 3МБ кэш, частота процессора - 3.90ГГц.
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[14]->price; ?>" data-short="<? echo $base->processors->cpu[14]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[25]->price; ?>" data-short="<? echo $base->processors->cpu[25]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Core i5-7500 4-Ядра 3.4 - 3.8GHz Turbo, LGA 1151, 65W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[15]->price; ?>" data-short="<? echo $base->processors->cpu[15]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Core i5-7600 4-Ядра 3.5 - 4.1GHz Turbo, LGA 1151, 65W TDP</div>
											<div class="radio_description_text">
												Процессор Intel Core™ i5 7-го поколения Kaby Lake. Предназначен для игровых компьютеров.
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[34]->price; ?>" data-short="<? echo $base->processors->cpu[34]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Core i5-7600K 4-Ядра 3.8 - 4.2GHz Turbo, LGA 1151, 91W TDP</div>
											<div class="radio_description_text">
												Процессор Intel Core™ i5 7-го поколения Kaby Lake. Предназначен для игровых компьютеров.
												4 ядра, 4 потока, 6МБ кэш, разблокированный множитель частота процессора от 3.80ГГц. до 4.20ГГц.
											</div>
											</div>
											<div class="radio_price"></div>
											<!-- <div class="new_label_info accessoriesPopup" modal-id="0">
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[39]->price; ?>" data-short="<? echo $base->processors->cpu[39]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/intel-core-i5-8600k.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="new">NEW!</div>
											<div class="radio_description_title">6-ядерный Intel Core i5-8400 2.8 - 4.0GHz Turbo, 65W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[40]->price; ?>" data-short="<? echo $base->processors->cpu[40]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="new">NEW!</div>
											<div class="radio_description_title">6-ядерный Intel Core i5-8600K 3.6 - 4.3GHz Turbo, 95W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[9]->price; ?>" data-short="<? echo $base->coolers->cooler[9]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/gammax300.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер для процессора DeepCool GAMMAXX 300</div>
											<div class="radio_description_text">
												Алюминиевый радиатор лучевой конструкции с медным сердечником. Большой 120 мм вентилятор обеспечивает мощный воздушный поток при малом шуме. Расчитан на 110 ватт.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[10]->price; ?>" data-short="<? echo $base->coolers->cooler[10]->short; ?>"><input name="cooler" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/zalman_optima.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер для процессора Zalman CNPS10X OPTIMA</div>
											<div class="radio_description_text">
												Тихий и качественный башенный кулер для процессора с технологией прямого контакта тепловых трубок. Синяя светодиодная подсветка 120 мм вентилятора. Расчитан на 150 ватт.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[7]->price; ?>" data-short="<? echo $base->coolers->cooler[7]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
										<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[9]->price; ?>" data-short="<? echo $base->videocards->videocard[9]->short; ?>" data-title="NVIDIA GeForce GTX 1050 ti, 4GB GDDR5"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[10]->price; ?>" data-short="<? echo $base->videocards->videocard[10]->short; ?>" data-title="NVIDIA GeForce GTX 1060, 3GB GDDR5 (VR-Ready)"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1060, 3GB GDDR5 (VR-Ready)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[11]->price; ?>" data-short="<? echo $base->videocards->videocard[11]->short; ?>" data-title="NVIDIA GeForce GTX 1060, 6GB GDDR5 (VR-Ready)"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1060, 6GB GDDR5 (VR-Ready)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[4]->price; ?>" data-short="<? echo $base->rams->ram[4]->short; ?>" data-title="8 GB [8 GB x1] DDR4 2100 MHz"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [8 GB x1] DDR4 2100 MHz Оперативной памяти</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[6]->price; ?>" data-short="<? echo $base->rams->ram[6]->short; ?>" data-title="GB [8 GB x1] DDR4-2100 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [8 GB x1] DDR4-2100 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[8]->price; ?>" data-short="<? echo $base->rams->ram[8]->short; ?>" data-title="8 GB [4 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [4 GB x2] DDR4-2100 Оперативной памяти</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[9]->price; ?>" data-short="<? echo $base->rams->ram[9]->short; ?>" data-title="8 GB [4 GB x2] DDR4-2100Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[10]->price; ?>" data-short="<? echo $base->rams->ram[10]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 MHz Оперативной памяти"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">16 GB [8 GB x2] DDR4-2100 MHz Оперативной памяти</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[12]->price; ?>" data-short="<? echo $base->rams->ram[12]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2400 G.Skill Trident Z RGB"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[13]->price; ?>" data-short="<? echo $base->rams->ram[13]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[14]->price; ?>" data-short="<? echo $base->rams->ram[14]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2400 Team T-Force Delta RGB White"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[16]->price; ?>" data-short="<? echo $base->rams->ram[16]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 G.Skill Trident Z RGB"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[17]->price; ?>" data-short="<? echo $base->rams->ram[17]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[18]->price; ?>" data-short="<? echo $base->rams->ram[18]->short; ?>" data-title="32 GB [8 GB x4] DDR4-2400 Team T-Force Delta RGB White"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[3]->price; ?>" data-short="<? echo $base->materinkas->materinka[3]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Socket-1151_Intel-Z270.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Socket 1151, (Intel® Z270 Chipset, 4 x DDR4, ATX)</div>
											<div class="radio_description_text">
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[12]->price; ?>" data-short="<? echo $base->materinkas->materinka[12]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Z370-HD3P.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="new">NEW!</div>
											<div class="radio_description_title">Gigabyte Z370 HD3P (обязательно выбирать для i5-8400 и i5-8600K)</div>
											<div class="radio_description_text">
												Универсальная, недорогая и надежная материнская плата. Создана на базе высококачественных компонентов. Предназначена для игровых компьютеров.
											</div>
											</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label block_label one_line_label" data-price="<? echo $base->blocks->block[5]->price; ?>" data-short="<? echo $base->blocks->block[5]->short; ?>"><input name="block" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
в различных разрешениях экрана
						...
						<div class="tabs_fps_container">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[18]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[18]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[18]->fps[0]; ?></div>
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[18]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[18]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[18]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[19]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[19]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[19]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[19]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[19]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[19]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Эпические</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[6]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[6]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[6]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[6]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[6]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[6]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[7]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[7]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[7]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[7]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[7]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[7]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[11]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[11]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[11]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[11]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[11]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[11]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[8]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[8]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[8]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[8]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[8]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[8]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[9]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[9]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[9]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[9]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[9]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[9]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[10]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[10]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[10]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[10]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[10]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[10]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[12]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[12]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[12]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[12]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[12]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[12]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[13]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[13]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[13]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[13]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[13]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[13]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[14]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[14]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[14]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[14]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[14]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[14]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[15]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[15]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[15]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[15]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[15]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[15]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[16]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[16]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[16]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[16]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[16]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[16]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[0]->games->game[17]->color[0]; ?>; width:<? echo $base->computers->comp[0]->games->game[17]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[0]->games->game[17]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[0]->games->game[17]->color[1]; ?>; width:<? echo $base->computers->comp[0]->games->game[17]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[0]->games->game[17]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
					...
					<div class="tab_content_inner" id="tab_video_content">
						...
						<div class="tabs_video_container">
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/gltupxf5jK4" frameborder="0" allowfullscreen></iframe>
							</div>
							<div class="tab_video">
								<iframe width="100%" height="100%" src=https://www.youtube.com/embed/ewG98Gw4Res?rel=0 frameborder="0" allowfullscreen></iframe>
							</div>

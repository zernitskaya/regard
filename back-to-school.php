...
<head>
	...
	<meta charset="utf-8">
	<title>Back to School - купить игровой ПК на базе AMD Radeon R7 Graphic, конфигурация, фото и отзывы | Компания РЕГАРД.com</title>
	<meta name="description" content="Back to School - игровой компьютер бюджетного сегмента для несложных задач, подойдет для офиса и домашнего использования. Собран на базе процессора AMD Radeon R7 со встроенной в процессор графикой">
	...
	<meta property="og:title"  content="Back to School - купить игровой ПК на базе AMD Radeon R7 Graphic, конфигурация, фото и отзывы | Компания РЕГАРД.com" />
	<meta property="og:description"  content="Back to School - игровой компьютер бюджетного сегмента для несложных задач, подойдет для офиса и домашнего использования. Собран на базе процессора AMD Radeon R7 со встроенной в процессор графикой" />
	<meta property="og:image"  content="http://xn--80afeb8cd.com/www/cases/socialnetworks/x04main.jpg" /> 
	<? 
	...
	<script src="js/credit6.js"></script>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[7]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[7]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[7]->nacenka->old; ?>;
		...
		<div class="main_photo_preview_modal clearfix">
			...
			<div class="main_photo_preview_main_photo_container">
				...
				<div class="main_photo_preview_video_container">
					<div class="photo_preview_video_innner" id="lightbox_video05">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/FzjPSRFM204" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video04">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/hdZN-JuUbbs" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video03">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/-Tw8Pyk8WLg" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video02">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/15yxe-a68zI" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video01">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/sFM-EmY4sCc" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
			...
			<!-- <div class="privat_info_all_price_title">Рассрочка оформляется на безналичную стоимость товара - <div class="privat_info_all_price_field"><span>0.00</span> грн.</div> б/н.</div> -->
 				<div class="privat_prod_flex_container">
 					<div class="privat_flex_inner" style="text-align:left;">
 						<label class="privat_radio_label"><input type="radio" name="privat" class="privat_radio_input" value="PP" checked>
 							<div class="privat_radio"></div>
 							<div class="privat_info_title">Оплата частями</div>
 							<img src="img/pp_logo.png" class="pr_cr_img_1">
 					...
 					<div class="privat_flex_inner">
 						<div class="privat_slider_wrapper">
 							<div class="payment_number_pp"><span>3</span> платежей на 
			 				<select class="privat_pp_slider_select">
			 					<option>1</option>
			 					<option selected>2</option>
			 				</select>
			 				мес.
			 				</div>
			 				<div class="privat_pp_slider"></div>
 					...
 					<div class="privat_flex_inner">
 						<div class="privat_info_payment_field_pp"><span>0.00</span> грн</div>
...
<div class="delivery_popup" id="dp">
	...
	<div class="delivery_popup" id="garp">
		...
		<div class="delivery_popup_container">
			<div class="delivery_popup_inner">
				<p>Вместе с компьютером вы получите официальную гарантию от РЕГАРД. Гарантия распространяется на каждое комплектующее отдельно, сроком от 1-го до 3-х лет. Срок гарантии указан в гарантийном талоне на каждое комплектующее отдельно. Компьютер не пломбируется, возможен самостоятельный апгрейд</p>
			</div>
		</div>
	</div>
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">Back to School</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">BACK TO SCHOOL</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер BACK TO SCHOOL</h1>
					...
					<div class="new_photo_block">
						<div class="side_photo_container_outer">
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									...
									<div class="side_mini_video" data-video="video05">
										<img src="img/video-preview.png">
									</div>
								</div>
							</div>
						...
						<div class="main_photo_container">
							...
							<div class="main_video_container">
								<div class="video_innner" id="video05">
									<iframe width="100%" height="100%" src="https://www.youtube.com/embed/FzjPSRFM204" frameborder="0" allowfullscreen></iframe>
								</div>
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">Игровой компьютер BACK TO SCHOOL</h1>
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span href="http://www.xn--80afeb8cd.com/back-to-school.html" class="comments_num_container">79</span> отзывов</a>
			...
			<div class="tabs_block">
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span href="http://www.xn--80afeb8cd.com/back-to-school.html" class="comments_num_container">79</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
									...
									<div class="new_tab_labels_container super_offer_labels_container">
										...
										<div class="super_offer_inner">
											...
											<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->offers->offer[0]->price; ?>">
												...
												<div class="radio_description">
													<div class="radio_description_flex_container">
														<div class="radio_description_title">Игровая клавиатура с LED подсветкой</div>
													</div>
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label one_line_label" data-price="<? echo $base->corpuses->corpus[10]->price; ?>"><input name="comp" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/component2359.jpg">
									</div>
									<div class="tab_labels_container">
									
									<label class="radio_label proc_label proc_label_3" data-price="<? echo $base->processors->cpu[53]->price; ?>" data-short="<? echo $base->processors->cpu[53]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A6-9500 8-ЯДЕР (2 вычислительных и 6 графических) 3.5 - 3.8 GHz Turbo, AM4, 65W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[54]->price; ?>" data-short="<? echo $base->processors->cpu[54]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A8-9600 10-ЯДЕР (4 вычислительных и 6 графических) 3.1 - 3.4GHz Turbo, AM4, 65W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[55]->price; ?>" data-short="<? echo $base->processors->cpu[55]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A10-9700 10-ЯДЕР (4 вычислительных и 6 графических) 3.5 - 3.8GHz Turbo, AM4, 65W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[56]->price; ?>" data-short="<? echo $base->processors->cpu[56]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A12-9800 12-ЯДЕР (4 вычислительных и 8 графических) 3.8 - 4.2GHz Turbo, AM4, 65W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/amd-radeon-graphics.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label videocard_label" data-price="0" data-short="AMD Radeon R7 Graphic" data-title="AMD Radeon R7 Graphic"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon™ R7 Graphic, 2ГБ (DirectX® 12, OpenCL 1.2 и Mantle)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
...
в различных разрешениях экрана
						...
						<div class="tabs_fps_container">
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									<div class="tabs_fps_game">CS:GO</div>
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[0]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[0]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[0]->fps[0]; ?></div>
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[0]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[0]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[0]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[1]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[1]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[1]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[1]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[1]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[1]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[2]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[2]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[2]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[2]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[2]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[2]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[3]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[3]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[3]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[3]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[3]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[3]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[4]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[4]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[4]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[4]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[4]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[4]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[5]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[5]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[5]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[5]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[6]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[6]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[6]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[6]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[6]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[6]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Очень высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[7]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[7]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[7]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[7]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[7]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[7]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Низкие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[8]->color[0]; ?>; width:<? echo $base->computers->comp[7]->games->game[8]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[8]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[8]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[8]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[8]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Низкие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[7]->games->game[9]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[9]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[7]->games->game[9]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[7]->games->game[9]->color[1]; ?>; width:<? echo $base->computers->comp[7]->games->game[9]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[7]->games->game[9]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
					...
					<div class="tab_content_inner" id="tab_video_content">
						...
						<div class="tabs_video_container">
							...
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/DGHLEaUK3bM" frameborder="0" allowfullscreen></iframe>
							</div>
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/15yxe-a68zI" frameborder="0" allowfullscreen></iframe>
							</div>

						...
						<div class="accordion product_accordion">
											...
											<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->offers->offer[2]->price; ?>" id="super_offer_windows">
												...
												<div class="radio_description">
													<div class="radio_description_flex_container">
														<div class="radio_description_title">Установить Microsoft Windows 10 HOME 64-bit Russian</div>
													</div>
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/A6-4000.jpg">
									</div>
									...
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[1]->price; ?>" data-short="<? echo $base->processors->cpu[1]->short; ?>"><input name="proc" type="radio" checked>
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A6-5400 2-ЯДРА 3.6 ГГц - 3.8 ГГц в режиме Turbo СORE, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_3" data-price="<? echo $base->processors->cpu[2]->price; ?>" data-short="<? echo $base->processors->cpu[2]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">2-ЯДРА AMD A6-7400 3,5 - 3,9GHz в режиме Turbo СORE, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[4]->price; ?>" data-short="<? echo $base->processors->cpu[4]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/A8-7600.jpg">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD A8-7600 10-ЯДЕР 3.1 ГГц - 3.8 ГГц в режиме Turbo СORE (4 вычислительных и 6 графических ядер), sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>

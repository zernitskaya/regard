...
<head>
	...
	<meta charset="utf-8">
	<title>Dominator Ultra - купить игровой ПК на базе AMD Athlon X4 845, конфигурация, фото и отзывы | Компания РЕГАРД.com</title>
	<meta name="description" content="Dominator Ultra - игровой ПК, представленный на базе процессора AMD Athlon X4 840 с видеокартой GeForce GTX 1050 2GB">
	...
	<style type="text/css">
		...
		.tabs_fps_scale_block:last-child{
			display: none;
		}
	...
	<meta property="og:title"  content="Dominator Ultra - купить игровой ПК на базе AMD Athlon X4 845, конфигурация, фото и отзывы | Компания РЕГАРД.com" />
	<meta property="og:description"  content="Dominator Ultra - игровой ПК, представленный на базе процессора AMD Athlon X4 840 с видеокартой GeForce GTX 1050 2GB" />
	<meta property="og:image"  content="http://xn--80afeb8cd.com/www/cases/socialnetworks/hellcat-pro1.jpg" /> 
	<? 
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[3]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[3]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[3]->nacenka->old; ?>;
			...
			$('.proc_label_1').on('click', function(){
				$('.mat_label').css('display', 'none')
				$('.mat_for_1').css('display', 'block')
				$('.mat_for_2 input').prop('checked', false)
				$('.mat_for_1 input').prop('checked', true)
			})


			$('.proc_label_2').on('click', function(){
				$('.mat_label').css('display', 'none');
				$('.mat_for_2').css('display', 'block');
				$('.mat_for_1 input').prop('checked', false);
				$('.mat_for_2_init input').prop('checked', true);
			})
		...
		<div class="main_photo_preview_modal clearfix">
			...
			<div class="main_photo_preview_main_photo_container">
				...
				<div class="main_photo_preview_video_container">
					<div class="photo_preview_video_innner" id="lightbox_video08">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/AN2y8v4THiE?rel=0" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video07">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/EKHHNH9gj5M?rel=0" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video06">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/trqi1KlD1eA?rel=0" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video09">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/TAzdmPNzmF0" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">Dominator Ultra</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">DOMINATOR ULTRA</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер DOMINATOR ULTRA</h1>
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">Игровой компьютер DOMINATOR ULTRA</h1>
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span href="http://www.xn--80afeb8cd.com/dominator-ultra.html" class="comments_num_container">64</span> отзывов</a>
			...
			<div class="tabs_block">
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span href="http://www.xn--80afeb8cd.com/dominator-ultra.html" class="comments_num_container">64</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
									...
									<div class="new_tab_labels_container super_offer_labels_container">
										...
										<div class="super_offer_inner">
											...
											<!--<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->offers->offer[0]->price; ?>">
												...
												<div class="radio_description">
													<div class="radio_description_flex_container">
														<div class="radio_description_title">[270] Игровая клавиатура с LED подсветкой (была 600 грн)</div>
													</div>
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										...
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/cases/76.png">
											<div class="zoom_in_hover photoPopup" modal-id="0">
												<img src="img/zoom-in.svg">
												<span>zoom</span>
											</div>
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">GreenVision X04</div>
											</div>
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/AMD-Athlon-X4-840.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[6]->price; ?>" data-short="<? echo $base->processors->cpu[6]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Athlon X4 840 4-ЯДРА 3.5 ГГц, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[7]->price; ?>" data-short="<? echo $base->processors->cpu[7]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Athlon X4 860K 4-ЯДРА 3.7 ГГц - 4.0 ГГц в режиме Turbo СORE, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[18]->price; ?>" data-short="<? echo $base->processors->cpu[18]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AMD-Fx.jpg">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="reccomend">Рекомендуем</div>
											<div class="radio_description_title">AMD FX-4300 4-ЯДРА 3.8 ГГц - 4.0 ГГц в режиме Turbo СORE, sAM3+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[19]->price; ?>" data-short="<? echo $base->processors->cpu[19]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="reccomend">Рекомендуем</div>
											<div class="radio_description_title">AMD FX-6300 6-ЯДЕР 3.5 ГГц - 4.1 ГГц в режиме Turbo СORE, sAM3+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[20]->price; ?>" data-short="<? echo $base->processors->cpu[20]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-8300 8-ЯДЕР 3.3 ГГц - 4.2 ГГц в режиме Turbo СORE, sAM3+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/FX-box-cooler.png">
									</div>
									<div class="new_tab_labels_container">
									...
									<label class="radio_label cooler_label recommend" data-price="<? echo $base->coolers->cooler[2]->price; ?>" data-short="<? echo $base->coolers->cooler[2]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер DeepCool Gamma Archer PRO</div>
											<div class="radio_description_text">
												Алюминиевый радиатор лучевой конструкции с медным сердечником. Большой 120 мм вентилятор обеспечивает мощный воздушный поток при малом шуме. Расчитан на 95 ватт.
											</div>
											</div>
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/gtx-1030.png">
									</div>
									<div class="tab_labels_container">
									
									
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[3]->price; ?>" data-short="<? echo $base->videocards->videocard[3]->short; ?>" data-title="NVIDIA GeForce GTX 750 Ti, 2GB GDDR5"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 750 Ti, 2GB GDDR5</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[6]->price; ?>" data-short="<? echo $base->videocards->videocard[6]->short; ?>" data-title="NVIDIA GeForce GTX 1050, 2GB GDDR5"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[9]->price; ?>" data-short="<? echo $base->videocards->videocard[9]->short; ?>" data-title="NVIDIA GeForce GTX 1050 ti, 4GB GDDR5"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">4 GB [4 GB x1] DDR3-1600 Модуля памяти</div>
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[21]->price; ?>" data-short="<? echo $base->rams->ram[21]->short; ?>" data-title="4 GB [4 GB x1] DDR3-1600 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[22]->price; ?>" data-short="<? echo $base->rams->ram[22]->short; ?>" data-title="4 GB DDR3-1600 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">4 GB DDR3-1600 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">8 GB [8 GB x1] DDR3-1600 Модуля памяти</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[23]->price; ?>" data-short="<? echo $base->rams->ram[23]->short; ?>" data-title="8 GB [8 GB x1] DDR3-1600 сертифицированная"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[24]->price; ?>" data-short="<? echo $base->rams->ram[24]->short; ?>" data-title="8 GB DDR3-1600 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB DDR3-1600 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">8 GB [4 GB x2] DDR3-1600 Модуля памяти</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[25]->price; ?>" data-short="<? echo $base->rams->ram[25]->short; ?>" data-title="8 GB [4 GB x2] DDR3-1600 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[26]->price; ?>" data-short="<? echo $base->rams->ram[26]->short; ?>" data-title="8 GB [4 GB x2] DDR3-1600  Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">8 GB [4 GB x2] DDR3-1600  Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">16 GB [8 GB x2] DDR3-1600 Модуля памяти</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[27]->price; ?>" data-short="<? echo $base->rams->ram[27]->short; ?>" data-title="16 GB [8 GB x2] DDR3-1600 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[28]->price; ?>" data-short="<? echo $base->rams->ram[28]->short; ?>" data-title="16 GB [8 GB x2] DDR3-1600 Kingston HyperX Fury"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
													...
													<div class="radio_description">
														<div class="radio_description_flex_container">
														<div class="radio_description_title">16 GB [8 GB x2] DDR3-1600 Kingston HyperX Fury</div>
														</div>
														<div class="radio_price"></div>
														<!-- <div class="new_label_info accessoriesPopup">
															<div class="new_label_info_inner">
							...
							<div class="accordion_block" id="accordion_storage">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
										<label class="radio_label hdd_label one_line_label" data-price="<? echo $base->hdds->hdd[0]->price; ?>" data-short="<? echo $base->hdds->hdd[0]->short; ?>" data-short="<? echo $base->hdds->hdd[0]->short; ?>"><input name="hdd" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[1]->price; ?>" data-short="<? echo $base->hdds->hdd[1]->short; ?>"><input name="hdd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label ssd_label big_line_label" data-price="<? echo $base->ssds->ssd[1]->price; ?>" data-short="<? echo $base->ssds->ssd[1]->short; ?>"><input name="ssd" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">120 GB SSDNow UV400 SATA-3 SSD -- Чтение: 500MB/s; Запись: 350MB/s</div>
											<div class="radio_description_text">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/FM2+_-AMD-A68H.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label mat_label mat_for_1" data-price="<? echo $base->materinkas->materinka[1]->price; ?>" data-short="<? echo $base->materinkas->materinka[1]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">FM2+, (AMD A68H, 2 x DDR3, MicroATX)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label mat_label mat_for_2_init mat_for_2" data-price="<? echo $base->materinkas->materinka[2]->price; ?>" data-short="<? echo $base->materinkas->materinka[2]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AM3+-AMD-760G.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AM3+ (AMD 760G, PCI-Ex16, 2 x DDR3, MicroATX)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/430w.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label block_label one_line_label" data-price="<? echo $base->blocks->block[5]->price; ?>" data-short="<? echo $base->blocks->block[5]->short; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">430W DeepCool</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
...
в различных разрешениях экрана
						...
						<div class="tabs_fps_container">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[18]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[18]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[18]->fps[0]; ?></div>
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[18]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[18]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[18]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средне-высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[19]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[19]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[19]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[19]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[19]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[19]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[6]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[6]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[6]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[6]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[6]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[6]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Низко-средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[7]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[7]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[7]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[7]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[7]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[7]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[11]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[11]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[11]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[11]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[11]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[11]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[8]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[8]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[8]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[8]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[8]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[8]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[0]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[0]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[0]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											...
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[0]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[0]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[0]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[1]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[1]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[1]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[1]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[1]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[1]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[2]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[2]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[2]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[2]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[2]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[2]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[3]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[3]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[3]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[3]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[3]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[3]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
							...
							<div class="tabs_fps_inner_block clearfix">
								<div class="tabs_fps_image">
									<img src="img/fallout.jpg">
								</div>
								<div class="tabs_fps_info">
									<div class="tabs_fps_game">Fallout 4</div>
									<div class="tabs_fps_settings">Full HD 1920x1080</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[4]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[4]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[4]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[4]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[4]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[4]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Средние</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[5]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[5]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[9]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[9]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[9]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[9]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[9]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[9]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[10]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[10]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[10]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[10]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[10]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[10]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[12]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[12]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[12]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[12]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[12]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[12]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[13]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[13]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[13]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[13]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[13]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[13]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Высокие</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[14]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[14]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[14]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[14]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[14]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[14]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[15]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[15]->percent[0]; ?>%;"></div>
											</div>-+
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[15]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[15]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[15]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[15]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[16]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[16]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[16]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[16]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[16]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[16]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Ультра</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[3]->games->game[17]->color[0]; ?>; width:<? echo $base->computers->comp[3]->games->game[17]->percent[0]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number fps_number_green"><? echo $base->computers->comp[3]->games->game[17]->fps[0]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">2K 2560X1440</div>
											<div class="fps_scale">
												<div class="fps_scale_filler" style="background-color:<? echo $base->computers->comp[3]->games->game[17]->color[1]; ?>; width:<? echo $base->computers->comp[3]->games->game[17]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_number"><? echo $base->computers->comp[3]->games->game[17]->fps[1]; ?></div>
											<div class="fps_fps">FPS</div>
										</div>
									</div>
								</div>
					...
					<div class="tab_content_inner" id="tab_video_content">
						...
						<div class="tabs_video_container">
							...
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/AN2y8v4THiE" frameborder="0" allowfullscreen></iframe>
							</div>
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/trqi1KlD1eA" frameborder="0" allowfullscreen></iframe>
							</div>
							<div class="tab_video">
								<iframe width="100%" height="100%" src="https://www.youtube.com/embed/EKHHNH9gj5M" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
						<div class="tab_content_inner_bottom_buttons">

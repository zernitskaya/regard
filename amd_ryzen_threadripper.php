...
<head>
	...
	<meta charset="utf-8">
	<title>AMD Ryzen Threadripper Конфигуратор</title>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[11]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[11]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[11]->nacenka->old; ?>;
...
<div class="delivery_popup" id="dp">
		...
		<div class="delivery_popup_container">
			<div class="delivery_popup_inner">
				<h4>Самовывоз из нашего магазина в Киеве<br>(ул. Ивана Выговского 13)</h4>
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_price"><? echo $base->computers->comp[11]->price; ?></div>
			<div class="bottom_computer_title">AMD Threadripper</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">AMD Ryzen Threadripper Конфигуратор</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">AMD Ryzen Threadripper Конфигуратор</h1>
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
							...
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									<div class="side_mini_photo active">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (2).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (5).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (7).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (9).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (11).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (6).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (3).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (4).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (10).jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/c23/c23 (8).jpg">
									</div>
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="http://xn--80afeb8cd.com/cases/1/c23/c23 (2).jpg" class="main_photo_image">
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">AMD Ryzen Threadripper Конфигуратор</h1>
						...
						<div class="product_page_flex_price">
							<div class="product_page_price_block_outer clearfix">
								...
								<div class="product_page_price_block clearfix">
									<div class="old_price"><? echo $base->computers->comp[11]->oldprice; ?> <span>грн</span>
										<div class="old_price_inner"></div>
									</div>
									<div class="new_price"><? echo $base->computers->comp[11]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[21]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/Threadripper.png">
									</div>
									<div class="tab_labels_container">
										<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[50]->price; ?>" data-short="<? echo $base->processors->cpu[50]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8-ядерный AMD Ryzen™ Threadripper 1900X 3.8 - 4.0GHz Turbo, 180W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[51]->price; ?>" data-short="<? echo $base->processors->cpu[51]->short; ?>"><input name="proc" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">12-ядерный AMD Ryzen™ Threadripper 1920X 3.5 - 4.0GHz Turbo, 180W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[52]->price; ?>" data-short="<? echo $base->processors->cpu[52]->short; ?>"><input name="proc" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">16-ядерный AMD Ryzen™ Threadripper 1950X 3.4 - 4.0GHz Turbo, 180W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[14]->price; ?>" data-short="<? echo $base->coolers->cooler[14]->short; ?>"><input name="cooler" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[20]->price; ?>" data-short="<? echo $base->coolers->cooler[20]->short; ?>"><input name="cooler" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Thermaltake.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Thermaltake Water 3.0 Extreme</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/asusx399.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[23]->price; ?>" data-short="<? echo $base->materinkas->materinka[23]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS PRIME X399-A -- 4x PCIe x16, 2x USB 3.1 Gen2, 8x USB 3.1 Gen1, 2x M.2, Aura RGB</div>
											<div class="radio_description_text">
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[24]->price; ?>" data-short="<? echo $base->materinkas->materinka[24]->short; ?>"><input name="mat" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/strix399-e.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ROG STRIX X399-E Gaming, AMD X399 Chipset, TR4, E-ATX</div>
											<div class="radio_description_text">
												Универсальная, недорогая и надежная материнская плата. Создана на базе высококачественных компонентов. Предназначена для игровых компьютеров.
											</div>
											</div>
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[25]->price; ?>" data-short="<? echo $base->materinkas->materinka[25]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/rog399.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS X399 ROG ZENITH EXTREME -- 4x PCIe x16, 2x USB 3.1 Gen2, 8x USB 3.1 Gen1, 3x M.2, Aura RGB</div>
											<div class="radio_description_text">
												Универсальная, недорогая и надежная материнская плата. Создана на базе высококачественных компонентов. Предназначена для игровых компьютеров.
											</div>
											</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label block_label" data-price="<? echo $base->blocks->block[4]->price; ?>" data-short="<? echo $base->blocks->block[4]->short; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

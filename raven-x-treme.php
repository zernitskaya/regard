...
<head>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[2]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[2]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[2]->nacenka->old; ?>;
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">RAVEN X-TREME</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">RAVEN X-TREME</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер RAVEN X-TREME</h1>
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">Игровой компьютер RAVEN X-TREME</h1>
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span href="http://www.xn--80afeb8cd.com/raven-x-treme.html" class="comments_num_container">47</span> отзывов</a>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/Core_i7-7700.png">
									</div>
									<div class="tab_labels_container">
										<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[16]->price; ?>" data-short="<? echo $base->processors->cpu[16]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Core i7-7700 4-Ядра 3.6 - 4.2GHz Turbo, LGA 1151, 65W TDP</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[17]->price; ?>" data-short="<? echo $base->processors->cpu[17]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Core_i7-7700K.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Core i7-7700K 4-Ядра 4.2 - 4.5GHz Turbo, LGA 1151, 91W TDP, без кулера</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[2]->price; ?>" data-short="<? echo $base->coolers->cooler[2]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[9]->price; ?>" data-short="<? echo $base->coolers->cooler[9]->short; ?>"><input name="cooler" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[11]->price; ?>" data-short="<? echo $base->coolers->cooler[11]->short; ?>"><input name="cooler" type="radio" >
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/gammax_gt.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер для процессора Deepcool GAMMAXX GT</div>
											<div class="radio_description_text">
												Замкнутая система водяного охлаждения, радиатор медь+алюминий, Максимальная рассеиваемая мощность 220Вт, Количество вентиляторов - 1, уровень шума: 25-32 дБ. Крутая LED подсветка вентилятора системы охлаждения.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[12]->price; ?>" data-short="<? echo $base->coolers->cooler[12]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Водяное охлаждение (СВО) CAPTAIN RED 120EX</div>
											<div class="radio_description_text">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[13]->price; ?>" data-short="<? echo $base->coolers->cooler[13]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/gygabyte_aoros.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер для процессора GIGABYTE AORUS ATC700</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[16]->price; ?>" data-short="<? echo $base->coolers->cooler[16]->short; ?>"><input name="cooler" type="radio">
										...
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/Captain120EX.gif">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Водяное охлаждение (СВО) DeepCool CAPTAIN 120EX RGB</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[14]->price; ?>" data-short="<? echo $base->coolers->cooler[14]->short; ?>"><input name="cooler" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Водяное охлаждение (СВО) Deepcool CAPTAIN 240EX RED</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[15]->price; ?>" data-short="<? echo $base->coolers->cooler[15]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/nkxt_kraken.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Водяное охлаждение (СВО) NZXT Kraken X52</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">16 GB [8 GB x2] DDR4-2100</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[10]->price; ?>" data-short="<? echo $base->rams->ram[10]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[0]->price; ?>" data-short="<? echo $base->materinkas->materinka[0]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[7]->price; ?>" data-short="<? echo $base->materinkas->materinka[7]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

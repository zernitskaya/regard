...
<body>
	...
	<div class="info_page">
		<div class="wrapper">
			<div class="info_page_title">ДОСТАВКА И ОПЛАТА</div>
			<div class="info_page_subtitle">Доставка  осуществляется только по предоплате</div>
			<div class="info_page_mini_block">
				<div class="info_page_mini_block_title">Способы оплаты:</div>
				<ul>
					<li>
						Наличными<br>
						Можно оплатить заказ в кассе магазина при самовывозе,<br>
						(г. Харьков Полтавский шлях 9)
					</li>
					<li>
						Наложенный платеж<br>
						Наложенный платеж возможен при доставке Новой Почтой.<br> Комиссия транспортной компании 2%.
					</li>
					<li>
						Предоплата на карту Приват Банка / Приват24
					</li>
				</ul>
			</div>
			<div class="info_page_mini_block">
				<div class="info_page_mini_block_title">Способы доставки:</div>
				<ul>
					<li>
						Самовывоз<br>
Товар можно забрать в Харькове, ул. Полтавский шлях 9. После<br> оформления заказа, менеджер перезвонит Вам и уточнит дату и <br>детали по заказу. Если товар есть на складе, забрать можно день<br> в день.
					</li>
					<li>
						Новая Почта<br>
Отправка день в день, если товар есть на складе и заказ<br> оформлен до 12:00. Если после 12:00, то на следующий день.<br> Если товара нет на складе или компьютер необходимо собрать,<br> то менеджер уточнит сроки доставки по телефону.

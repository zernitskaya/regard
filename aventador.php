...
<head>
	...
	<script type="text/javascript">
		var	ppPercentPrice = <? echo $base->computers->comp[9]->pp; ?>;
		var device = "<?=$_SERVER['HTTP_USER_AGENT'];?>";
		$(document).ready(function(){

			addToNewPrice = <? echo $base->computers->comp[9]->nacenka->new; ?>;
			addToOldPrice = <? echo $base->computers->comp[9]->nacenka->old; ?>;
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">Aventador</div>
		</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › игровой компьютер <span class="product_page_name">AVENTADOR</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<div class="product_page_flex_container clearfix">
				<h1 class="product_page_title_mobile">Игровой компьютер AVENTADOR</h1>
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
							...
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									<div class="side_mini_photo active">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-311.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-292.jpg">
									</div>
									
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-297.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-298.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-299.jpg">
									</div>
									
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-317.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-318.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-405.jpg">
									</div>
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-311.jpg" class="main_photo_image">
				...
				<div class="product_page_price_flex_info_block">
					<h1 class="product_page_title">Игровой компьютер AVENTADOR</h1>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[6]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/intel-core-i7-8700.png">
									</div>
								<div class="tab_labels_container">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[38]->price; ?>" data-short="<? echo $base->processors->cpu[38]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/intel-core-i3-8100.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">4-ядерный Intel Core i3-8350K 4.00 GHz, 91W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[41]->price; ?>" data-short="<? echo $base->processors->cpu[41]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">6-ядерный Intel Core i7-8700 3.2 - 4.6GHz Turbo, 65W TD</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[42]->price; ?>" data-short="<? echo $base->processors->cpu[42]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/intel-core-i7-8700k.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">6-ядерный Intel Core i7-8700K 3.7 - 4.7GHz Turbo, 95W</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">16 GB [8 GB x2] DDR4-2100
												00</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
											...
											<div class="label_dropdown_content active" style="display:block">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[11]->price; ?>" data-short="<? echo $base->rams->ram[11]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									<div class="new_side_photo_container">
										<img src="http://xn--80afeb8cd.com/newimg/asus_Prime-Z370-P.png">
									</div>
									<div class="tab_labels_container">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[13]->price; ?>" data-short="<? echo $base->materinkas->materinka[13]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS PRIME Z370-P - 2x PCIe x16, 4x USB 3.1, 2x USB 2.0</div>
											<div class="radio_description_text">
									...
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[15]->price; ?>" data-short="<? echo $base->materinkas->materinka[15]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/PRIME-Z370-A.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS PRIME Z370-A, Intel Z370 Chipset, LGA 1151, HDMI, ATX</div>
											<div class="radio_description_text">
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[16]->price; ?>" data-short="<? echo $base->materinkas->materinka[16]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/ROG-STRIX-Z370-F-GAMING.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASUS ROG STRIX Z370-F GAMING, Intel Z370 Chipset, LGA 1151, HDMI</div>
											<div class="radio_description_text">
												Универсальная, недорогая и надежная материнская плата. Создана на базе высококачественных компонентов. Предназначена для игровых компьютеров.
											</div>
											</div>

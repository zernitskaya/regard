	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.to_top_btn').on('click', function(){
			 ...
			 $('.phone_mask').mask('+38 (000) 000-00-00',{placeholder: '+38 (000) 000-00-00'});
...
<body class="product_body">
	...
	<div class="bg_modal product_buy_modal">
		<div class="modal_inner product_buy_inner">
			...
			<input type="tel" class="form_input_tel phone_mask">
...
<div class="delivery_popup" id="dp">
	...
	<div class="delivery_popup" id="pchk" style="height:220px;">
		<div class="delivery_close_icon">
			×
		</div>
		<div class="delivery_popup_container">
			<div class="delivery_popup_inner">
				<p>Введите свой адрес эл.почты и мы вас оповестим, когда товар станет<br>дешевле</p>
				...
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="img/roundphoto02.jpg" class="main_photo_image">
							...
							<div class="product_page_price_block_outer clearfix">
								...
								<div class="product_page_price_block clearfix">
									...
									<div class="new_credit_block">
										...
										<div class="new_credit_info">25 x <span class="new_credit_sum">1900</span> грн/мес</div>
									</div>
								</div>
										...
										<div class="super_offer_inner">
											<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[0]->price; ?>">
												...
												<div class="radio_img">
													...
													<div class="zoom_in_hover" data-modal="accessPopup01" modal-id="0">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[0]->price; ?>"><input name="comp" type="radio">
										...
										<label class="radio_label comp_label new" data-price="<? echo $base->corpuses->corpus[1]->price; ?>"><input name="comp" type="radio">
											...
											<div class="radio_img">
												<img src="img/newblock.png">
												<div class="zoom_in_hover" modal-id="0">
													<img src="img/zoom-in.svg">
													<span>zoom</span>
												</div>
											</div>

						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[11]->price; ?>" data-short="<? echo $base->videocards->videocard[11]->short; ?>" data-title="NVIDIA GeForce GTX 1060 - 6GB (VR-Ready)"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<div class="tab_labels_container">
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn">
												...
												<div class="label_dropdown_btn_title">8 GB [8 GB x1] DDR4-2400</div>
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">16 GB [8 GB x2] DDR4-2400</div>
												<div class="label_dropdown_btn_price"></div>
												<!-- <div class="new_label_info accessoriesPopup">
													<div class="new_label_info_inner">
														<img src="img/newlabelinfo.png">
											...
											<div class="label_dropdown_content active" style="display:block">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[13]->price; ?>" data-short="<? echo $base->rams->ram[13]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[29]->price; ?>" data-short="<? echo $base->rams->ram[29]->short; ?>" data-title="16 GB [8 GB x2] DDR4-2100 сертифицированная"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
										<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[9]->price; ?>" data-short="<? echo $base->materinkas->materinka[9]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AB350M-HDV(L2).png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">ASRock AB350M-HDV Socket AM4</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label block_label" data-price="<? echo $base->blocks->block[2]->price; ?>" data-short="<? echo $base->blocks->block[2]->short; ?>"><input name="block" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/img/component2215.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Raidmax 730W (80PLUS Bronze)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>

...
<head>
	...
	<meta property="og:title"  content="Hellcat PRO" />
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/hellcat-pro1.jpg" /> 
	<? 
...
<body>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Hellcat PRO</span>
		</div>
	</div>
			...
			<div class="product_page_flex_container">
				<div class="product_page_flex_inner">
					...
					<div class="mini_photos_container container_for_10">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-102.jpg" class="lightbox_link">
									<img src="img/RECARD-102.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-108.jpg" class="lightbox_link">
									<img src="img/RECARD-108.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-77.jpg" class="lightbox_link">
									<img src="img/RECARD-77.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-157.jpg" class="lightbox_link">
									<img src="img/RECARD-157.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price"><? echo $base->computers->comp[4]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price new_price_black"><? echo $base->computers->comp[4]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[18]->price; ?>"><input name="proc" type="radio">
...
процессора - 3.80ГГц. Максимальная частота в турбо режиме - 4.00ГГц. Тепловыделение - 95W
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[19]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-6300 4,1GHz, sAM3+
											</div>
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 6 ядер, 8МБ кэш L3. Базовая частота
процессора - 3.50ГГц. Максимальная частота в турбо режиме - 4.10ГГц. Тепловыделение - 95W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[20]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-8300 4,2GHz, sAM3+
											</div>
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 8 ядер, 8МБ кэш L3. Базовая частота
процессора - 3.30ГГц. Максимальная частота в турбо режиме - 4.20ГГц. Тепловыделение - 95W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 7008 МГц.  (DVI-D, DisplayPort, HDMI)
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[3]->price; ?>"><input name="videocard" type="radio"  checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
								...
								<div class="accordion_content">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[0]->price; ?>"><input name="cooler" type="radio" checked>
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Стандартный алюминиевый радиатор с квадратным основанием, к которому прикреплены четыре секции ребер, и низкопрофильный вентилятор. Расчитан на 95-ваттные процессоры AMD.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[2]->price; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block monitor_block">
								...
								<div class="accordion_content">
									<label class="radio_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[0]->price; ?>">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Монитор 19" Asus VS207DF</div>
											<div class="radio_description_text">
...
Матовое покрытие экрана. Подсветка WLED (светодиодная подсветка). Соотношение сторон 16:9
									...
									<label class="radio_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[4]->price; ?>">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Монитор 24" Philips 243V5QSBA/01</div>
											<div class="radio_description_text">

...
<head>
	...
	<meta property="og:title"  content="Dominator Ultra" />
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/dominator-ultra1.jpg" /> 
	<? 
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.proc_label_2').on('click', function(){
				...
				$('.mat_for_2 input').prop('checked', true);
			})
...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Dominator Ultra</span>
		</div>
	</div>
			...
			<div class="product_page_flex_container">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price"><? echo $base->computers->comp[3]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price new_price_black"><? echo $base->computers->comp[3]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[6]->price; ?>"><input name="proc" type="radio" checked>
										...
										<div class="radio_description">
											...
											<div class="radio_description_title">AMD Athlon X4 840 3,8GHz, sFM2+
											</div>
											<div class="radio_description_text">
												Предназначен для недорогих игровых компьютеров. Сокет FM2+, 4 ядра, Kaveri, 4МБ кэш.
Базовая частота процессора - 3.10ГГц. Максимальная частота в турбо режиме - 3.80ГГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[7]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Athlon X4 860K 4,0GHz, sFM2+
											</div>
											<div class="radio_description_text">
												Поставляется с мощной системой охлаждения. 4 ядра, 4МБ кэш. Базовая частота
процессора - 3.70ГГц. Максимальная частота в турбо режиме - 4.00ГГц. Тепловыделение - 95W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[18]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-4300 4,0GHz, sAM3+
											</div>
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 4 ядра, 4МБ кэш L3. Базовая частота
процессора - 3.80ГГц. Максимальная частота в турбо режиме - 4.00ГГц. Тепловыделение - 95W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[0]->price; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GT 730, 2GB GDDR5 (VGA, DVI, HDMI)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Поддерживает DirectX 11, что обеспечивает беспрецедентную реалистичность графики и эффекты кинематографического уровня.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[1]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GT 740, 2GB GDDR5 (128bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Поддерживает DirectX 11, OpenGL 4.4
Частота памяти - 5000 МГц. Разрядность шины памяти - 128 бит. (VGA, DVI, HDMI)
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Поддерживает DirectX 11.2, OpenGL 4.4 Частота памяти - 5400 МГц.  (DVI x2, HDMI, VGA)
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[2]->price; ?>"><input name="hdd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label mat_label mat_for_1" data-price="<? echo $base->materinkas->materinka[1]->price; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">FM2+, AMD A68H, MicroATX (2 x DDR3, USB 3.0)</div>
											<div class="radio_description_text">
									...
									<label class="radio_label mat_label mat_for_2" data-price="<? echo $base->materinkas->materinka[2]->price; ?>" display="none"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

...
$(document).ready(function(){
 ...
 //       }
	...
	$('.product_buy_inner .modal_sumbit').on('click', function(event) {
		...
		$.post('php/new_lid.php', { city: city_name, utm_term: utm_term, utm_content: utm_content, utm_compaign: utm_compaign, utm_source: utm_source, utm_medium: utm_medium, name: name, tel: tel, wifi: wifi, msoffice: msoffice, windows: windows, price: newPrice, type: 'product', monitor: monitor, keyboard: keyboard, complect: complect, mouse: mouse, cpu: procTitle, hdd: hddTitle, video: videocardTitle, budget: post_price, ram: ddrTitle, ssd: ssdTitle, cooler: coolerTitle, materinka: matTitle, block_pit: blockTitle, disk: diskTitle, corpus: compTitle, comp_name: comp_name, email: email, tel: tel, carpet: carpet, cabel: cabel, garn: garn, wifiadapt: wifiadapt, fan: fanTitle, soft: software, dop_vents: dopVents, offer: offer}, function(data) {
			console.log(data);
 ...
 //    });
    ...
    $('.privat_prod_inner .input_form_btn').click(function(event){
		...
		if (merch_type != undefined) {
			$.post('php/create_credit.php', { merch_type: merch_type, parts: parts, email: email, city: city_name, utm_term: utm_term, utm_content: utm_content, utm_compaign: utm_compaign, utm_source: utm_source, utm_medium: utm_medium, name: name, tel: tel, wifi: wifi, msoffice: msoffice, windows: windows,  parts: parts, price: summa, type: 'product', monitor: monitor, keyboard: keyboard, complect: complect, mouse: mouse, cpu: procTitle, hdd: hddTitle, video: videocardTitle, budget: post_price, ram: ddrTitle, ssd: ssdTitle, cooler: coolerTitle, materinka: matTitle, block_pit: blockTitle, disk: diskTitle, corpus: compTitle, comp_name: comp_name, tel: tel, carpet: carpet, cabel: cabel, garn: garn, wifiadapt: wifiadapt, fan: fanTitle, soft: software, dop_vents: dopVents, offer: offer}, function(data) {

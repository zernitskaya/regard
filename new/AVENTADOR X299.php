...
<head>
	...
	<meta property="og:title"  content="AVENTADOR X299" />
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/raven-x-treme1.jpg" /> 
	<? 
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">AVENTADOR X299</div>
		</div>
	</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">AVENTADOR X299</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<h1 class="product_page_title">Игровой компьютер AVENTADOR X299</h1>
			<div class="product_page_flex_container">
				<div class="product_page_flex_inner">
					<div class="main_prod_photo">
						<div class="thumbnail">
							<a href="img/RECARD-4.jpg" class="lightbox_link">
								<img src="img/RECARD-4.jpg">
							</a>
						</div>
					</div>
					<div class="mini_photos_container">
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-22.jpg" class="lightbox_link">
									<img src="img/RECARD-22.jpg">
								</a>
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-25.jpg" class="lightbox_link">
									<img src="img/RECARD-25.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-154.jpg" class="lightbox_link">
									<img src="img/RECARD-154.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-135.jpg" class="lightbox_link">
									<img src="img/RECARD-135.jpg">
								</a>	
							</div>
						</div>
					</div>
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price"><? echo $base->computers->comp[2]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price"><? echo $base->computers->comp[2]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[16]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/intel3.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Intel Core i7-7700 4.20 GHz, s1151
												<span>Kaby Lake</span></div>
											<div class="radio_description_text">
												Процессор Intel® Core™ i7 7-го поколения Kaby Lake. Предназначен для мощных игровых систем.
												4 ядра, 8 потоков, 8МБ кэш, частота процессора от 3.60ГГц. до 4.20ГГц. Тепловыделение 65W.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[17]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Intel Core i7-7700K 4.50 GHz, s1151
												<span>Kaby Lake</span></div>
											<div class="radio_description_text">
												Процессор Intel® Core™ i7 7-го поколения Kaby Lake. Предназначен для мощных игровых систем.
4 ядра, 8 потоков, 8МБ кэш, частота процессора от 4.20ГГц. до 4.50ГГц. Тепловыделение 91W.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[7]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8008 МГц.  (DVI-D, DisplayPort, HDMI)
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[9]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/nvidia3.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1070, 8GB GDDR5 (256bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта высокого уровня. Обеспечивает ультра настройки во всех новых играх.
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8008 МГц.  (DVI-D, 2 x DisplayPort, 2 x HDMI)
									...
									<label class="radio_label videocard_label ultra_line_label" data-price="<? echo $base->videocards->videocard[10]->price; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/nvidia4.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1080, 8GB GDDR5X</div>
											<div class="radio_description_text">
												Предназначена для мощных и сверхмощных игровых компьютеров. Игровая видеокарта с беспрецедентной производительностью! Флагманский GPU NVIDIA GeForce GTX 1080 - самая технически продвинутая игровая видеокарта на планете. Это геймерская модель высшего класса, оснащенная множеством эксклюзивных технологий. Совместимые с VR-устройствами порты HDMI дают возможность окунуться в захватывающий мир виртуальной реальности.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label ultra_line_label" data-price="<? echo $base->videocards->videocard[13]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1080 Ti, 11GB GDDR5X</div>
											<div class="radio_description_text">
												Предназначена для мощных и сверхмощных игровых компьютеров. GeForce GTX 1080 Ti - это новая флагманская игровая видеокарта NVIDIA, обладающая экстремальной игровой производительностью! Создана на основе архитектуры NVIDIA Pascal. Позволяет играть в 4K разрешении с FPS, о которых Вы и не мечтали.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[2]->price; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[3]->price; ?>"><input name="cooler" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/cooler3.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[1]->price; ?>"><input name="ddr" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8GB, 2100MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
									...
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[2]->price; ?>"><input name="ddr" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8GB, (2x4GB) 2100MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
									...
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[3]->price; ?>"><input name="ddr" type="radio" checked>
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">16GB, (2x8GB) 2100MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
										...
										<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[4]->price; ?>"><input name="ddr" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/ddr3.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">32GB, (4x8GB) 2100MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Комплект из 4-х модулей по 8ГБ сверхнадежной памяти DDR4 с частотой 2100 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[3]->price; ?>"><input name="hdd" type="radio" checked>
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">1TB TOSHIBA HDD</div>
											<div class="radio_description_text">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[4]->price; ?>"><input name="hdd" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">2TB TOSHIBA HDD</div>
											<div class="radio_description_text">
												Надежный и очень быстрый диск! Огромный буфер в сочетании с превосходной производительностью и высокой надежностью - вот отличительные особенности.
											</div>
											</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label ssd_label big_line_label" data-price="<? echo $base->ssds->ssd[2]->price; ?>"><input name="ssd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label ssd_label big_line_label" data-price="<? echo $base->ssds->ssd[3]->price; ?>"><input name="ssd" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/ssd4.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">500GB Samsung 850 Evo-Series, SATA III TLC</div>
											<div class="radio_description_text">
												SSD-накопители Samsung изготавливаются с использованием инновационной архитектуры 3D V-NAND, что позволяет создать память, одновременно емкую, быструю и надежную. Samsung самостоятельно выпускает все компоненты своих SSD-накопителей. Результатом этого является высочайшая надежность, эффективность и слаженность работы всех компонентов SSD-накопителя.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[0]->price; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[7]->price; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/materinka1.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Socket 1151 GigaByte, (Intel B150 Chipset, 4 x DDR4, MicroATX)</div>
											<div class="radio_description_text">
												Универсальная, недорогая и надежная материнская плата. Создана на базе высококачественных компонентов. Предназначена для игровых компьютеров.
											</div>
											</div>
									...
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[3]->price; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Socket 1151 GigaByte, (Intel® Z170 Chipset, 4 x DDR4, ATX)</div>
											<div class="radio_description_text">
												Материнская плата с разъемом процессора socket 1151 и набором системной логики Intel Z170. Создана на базе высококачественных компонентов, обладает великолепными техническими характеристиками. Предназначена для мощных игровых систем.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label block_label one_line_label" data-price="<? echo $base->blocks->block[0]->price; ?>"><input name="block" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label block_label" data-price="<? echo $base->blocks->block[2]->price; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Chieftec 700W</div>
											<div class="radio_description_text">
												Тихий надежный блок питания мощностью 700Вт от Chieftec.
Сертифицирован по стандарту 80 PLUS®. Предназначен для мощных игровых компьютеров.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
								...
								<div class="accordion_content">
									<label class="radio_label comp_label one_line_label" data-price="<? echo $base->corpuses->corpus[2]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Яркий и стильный корпус черного цвета формата Mid-Tower. По умолчанию без кулера с синей подсветкой.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[10]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_img">
											<a href="img/Frontier-Extractor2.jpg" class="zoom_link">
												<img src="img/Frontier-Extractor.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[11]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_img">
											<a href="img/Frontier-Warrior2.jpg" class="zoom_link">
												<img src="img/Frontier-Warrior.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[12]->price; ?>"><input name="comp" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<a href="img/Frontier-Rainbow2.jpg" class="zoom_link">
												<img src="img/Frontier-Rainbow.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[9]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_img">
											<a href="img/frime901.jpg" class="zoom_link">
												<img src="img/Frime-FC-901.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[8]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_img">
											<a href="img/A1.jpg" class="zoom_link">
												<img src="img/Aerocool-PGS1.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[4]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Raidmax Viper 2</div>
											<div class="radio_description_text">
												Превосходная вентиляция корпуса. 120-миллиметровый вентилятор. На лицевой панели 1 x USB 3.0, 1 x USB 2.0 и аудио-порты. Крутой игровой дизайн корпуса никого не оставит равнодушным. Размеры (49 x 20,6 x 46,2 см)
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[5]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Raidmax NINJA 2 Black</div>
											<div class="radio_description_text">
												Спереди: 1 x 120 мм White LED, Сзади: 1 x 120 мм. На лицевой панели 1 x USB 3.0, 1 x USB 2.0 и аудио-порты. Крутой игровой дизайн корпуса никого не оставит равнодушным. Размеры (49,1 x 20,6 x 46,2 см)
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[6]->price; ?>"><input name="comp" type="radio">
										...
										<div class="radio_img">
											<a href="img/aerocool2.jpg" class="zoom_link">
												<img src="img/Aerocool.png">
											</a>	
											<div class="zoom_link_hover">
												<img src="img/lupa.png">
											</div>
							...
							<div class="accordion_block monitor_block">
								...
								<div class="accordion_content">
									<label class="radio_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[0]->price; ?>">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Монитор 19" LG 19M38A-B</div>
											<div class="radio_description_text">
												Максимальное разрешение дисплея 1366x768 HD. Тип матрицы: TN. Интерфейсы: VGA.
...
Матовое покрытие экрана. Подсветка WLED (светодиодная подсветка). Соотношение сторон 16:9
									...
									<label class="radio_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[3]->price; ?>">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Монитор 22" Philips 223V5LSB2/62 FullHD</div>
											<div class="radio_description_text">
...
Матовое покрытие экрана. Подсветка WLED (светодиодная подсветка). Соотношение сторон 16:9
									...
									<label class="radio_label"><input type="checkbox" data-price="<? echo $base->monitors->monitor[8]->price; ?>">
										<div class="tabs_checkbox">
										</div>
										<div class="radio_img">
											<img src="img/mon5.png">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Монитор 24" SAMSUNG LS24D300HSI VGA HDMI Black</div>
											<div class="radio_description_text">
												Максимальное разрешение дисплея 1920x1080. Тип матрицы: TN+film. Интерфейсы: HDMI, VGA. Матовое покрытие экрана. Подсветка WLED (светодиодная подсветка). Соотношение сторон 16:9
											</div>
											</div>
...
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,moimir,gplus,viber,skype,telegram"></div>
				...
				<a href="AVENTADOR X299.html" class="computers_footer_link">
					AVENTADOR X299

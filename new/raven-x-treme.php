...
<head>
	...
	<meta property="og:title"  content="Raven X-Treme" />
...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Raven X-Treme</span>
		</div>
	</div>
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8008 МГц.  (DVI-D, 2 x DisplayPort, 2 x HDMI)
									...
									<label class="radio_label videocard_label ultra_line_label" data-price="<? echo $base->videocards->videocard[10]->price; ?>"><input name="videocard" type="radio" checked>
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1080 ASUS ROG STRIX 8G GAMING, 8GB GDDR5X</div>
											<div class="radio_description_text">
												Предназначена для мощных и сверхмощных игровых компьютеров. Игровая видеокарта с беспрецедентной производительностью! Флагманский GPU NVIDIA GeForce GTX 1080 - самая технически продвинутая игровая видеокарта на планете. Видеокарта ROG Strix GTX 1080 – это геймерская модель высшего класса, оснащенная множеством эксклюзивных технологий ASUS. Совместимые с VR-устройствами порты HDMI дают возможность окунуться в захватывающий мир виртуальной реальности. Стильная светодиодная подсветка Aura RGB, реализованная на видеокартах серии ROG Strix, предлагает насладиться миллионами цветовых комбинаций в сочетании с шестью завораживающими визуальными эффектами.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>

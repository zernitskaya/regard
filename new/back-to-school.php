...
<head>
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/back-to-school1.jpg" /> 
	<!--[if lt IE 9]>
...
<div class="delivery_popup" id="dp">
		...
		<div class="product_wrapper">
			<div class="product_header_flex_container">
				...
				<div class="header_computer_link_flex">
					<a href="zeus-evo.html" class="header_computer_link">
						<div class="header_computer_link_title">Zeus Evo</div>
						<div class="header_computer_link_price"><? echo $base->computers->comp[6]->price; ?> грн</div>
					</a>
					...
					<a href="dominator-ulta.html" class="header_computer_link">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Back to School</span>
		</div>
	</div>
			...
			<div class="product_page_flex_container">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price" style="display:none;"><? echo $base->computers->comp[7]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price new_price_black"><? echo $base->computers->comp[7]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[3]->price; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											...
											<div class="radio_description_title">4-ЯДРА AMD A8-5500 3,7GHz, sFM2+
											</div>
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 4 ядра, 4МБ кэш L2. Базовая частота
процессора - 3.20ГГц. Максимальная частота в турбо режиме - 3.70ГГц. Тепловыделение - 65W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[4]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 10 ядер (4 CPU + 6 GPU), 4МБ кэш L2. Базовая частота
процессора - 3.10ГГц. Максимальная частота в турбо режиме - 3.80ГГц. Тепловыделение - 65W
									...
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[5]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 12 ядер (4 CPU + 8 GPU), 4МБ кэш L2. Базовая частота
процессора - 3.50ГГц. Максимальная частота в турбо режиме - 3.90ГГц. Тепловыделение - 65W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label videocard_label videocard_label_for_1" data-price="0"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon R7 Graphics, 2GB (128bit, DirectX® 12)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Видеокарта поддерживает DirectX 12, OpenCL 1.2 и Mantle. Разрядность шины памяти - 128 бит. (D-Sub, DVI-D, HDMI)
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label videocard_label_for_2" data-price="0" style="display:none"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title"> AMD Radeon HD7560D, 2GB (128bit)</div>
											<div class="radio_description_text">

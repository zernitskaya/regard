...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › <span class="product_page_name">игровой компьютер RAVEN X-TREME</span>
		</div>
	</div>
						...
						<div class="side_photo_container_outer">
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									...
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-293.jpg">
									</div>
									<div class="side_mini_photo">
									...
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-300.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-301.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-302.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-307.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-308.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-309.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/cases/1/AEROCOOL-P7/PCS_21092017_-310.jpg">
									</div>
									<div class="side_mini_photo">
						...
						<div class="main_photo_container">
							...
							<div class="main_video_container">
								<div class="video_innner" id="video01">
									<iframe width="100%" height="100%" src="https://www.youtube.com/embed/c9LNkDLxsNM" frameborder="0" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span class="comments_num_container">47</span> отзывов</a>
				...
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span class="comments_num_container">47</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									...
									<div class="tab_labels_container">
										<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[16]->price; ?>" data-short="<? echo $base->processors->cpu[16]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[17]->price; ?>" data-short="<? echo $base->processors->cpu[17]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[3]->price; ?>" data-short="<? echo $base->coolers->cooler[3]->short; ?>"><input name="cooler" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<!-- Блок видеокарт -->
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video">
												<label class="radio_label videocard_label video_double_label" data-price="<? echo $base->videocards->videocard[14]->price; ?>" data-short="<? echo $base->videocards->videocard[14]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label" data-price="<? echo $base->videocards->videocard[15]->price; ?>" data-short="<? echo $base->videocards->videocard[15]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video active" style="display:block">
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[18]->price; ?>" data-short="<? echo $base->videocards->videocard[18]->short; ?>"><input name="videocard" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[19]->price; ?>" data-short="<? echo $base->videocards->videocard[19]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[3]->price; ?>" data-short="<? echo $base->materinkas->materinka[3]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[2]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[2]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">

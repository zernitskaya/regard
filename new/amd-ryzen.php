...
<head>
	...
	<meta property="og:title"  content="AMD Ryzen" />
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/amd-ryzen1.jpg" /> 
	<? 
...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">AMD Ryzen</span>
		</div>
	</div>
			...
			<div class="product_page_flex_container">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price"><? echo $base->computers->comp[1]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price"><? echo $base->computers->comp[1]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[21]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/ryzen5.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">4-x ядерный AMD Ryzen 5 1400 3.4GHz
											</div>
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[22]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">4-x ядерный AMD Ryzen 5 1500X 3.7GHz</div>
											<div class="radio_description_text">
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[23]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">6-ти ядерный AMD Ryzen 5 1600 3.6GHz</div>
											<div class="radio_description_text">
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[24]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/ryzen7.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8-ми ядерный AMD Ryzen 7 1700 3.7GHz</div>
											<div class="radio_description_text">
												8 ядер, 16 потоков, 16МБ кэш, частота процессора от 3.00ГГц до 3.70ГГц
												AM4, Ryzen 7, Тепловыделение 65Вт, Разблокированный множитель
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8000 МГц.  (DVI-D, 2 x DisplayPort, 2 x HDMI)
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[9]->price; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">NVIDIA GeForce GTX 1070, 8GB GDDR5 ASUS (256bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта высокого уровня. Обеспечивает ультра настройки во всех новых играх.
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8008 МГц.  (DVI-D, 2 x DisplayPort, 2 x HDMI)
											</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[3]->price; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[3]->price; ?>"><input name="ddr" type="radio" checked>
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">32GB, (2x16GB) 2100MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Комплект из 2-х модулей по 16ГБ сверхнадежной памяти DDR4 с частотой 2100 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[4]->price; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/b350.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Socket AM4, (AMD B350, 4 x DDR4, USB 3.1 Type-C)</div>
											<div class="radio_description_text">
												Чипсет AMD B350 | 4 -слота DDR4 1866-3200 (OC)+ МГц | max 64GB | 1xPCI-E x16, 2xPCI-E x1, слот M2, 3xUSB 3.0, 1xUSB 3.1 Type-C, 2xUSB 2.0 | звук 7.1 Realtek ALC 887-VD2 HDA | 1000 Мбит/с | DVI-D, VGA, HDMI | mATX
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label mat_label big_line_label" data-price="<? echo $base->materinkas->materinka[5]->price; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/x370.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Socket AM4, X370 Gaming Pro Carbon (AMD X370, 4 x DDR4, USB 3.1 Type-C, ATX)</div>
											<div class="radio_description_text">
												Чипсет AMD X370 | 4 -слота DDR4 1866-3200 (OC)+ МГц | max 64GB | 3xPCI-E x16, 2 слота M2, 5xUSB 3.1, USB 3.1 Type-C, 2xUSB 2.0 | звук 7.1 Realtek S1220A HDA | Optical SPDIF | 1000 Мбит/с | DVI-D, HDMI | ATX | CrossFireX | SLI | Управляемая LED подсветка
											</div>
											</div>
											<div class="radio_price"></div>
										</div>

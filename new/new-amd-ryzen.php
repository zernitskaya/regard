...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › <span class="product_page_name">игровой компьютер AMD RYZEN</span>
		</div>
	</div>
					...
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span class="comments_num_container">14</span> отзывов</a>
				...
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span class="comments_num_container">14</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_cooler">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[3]->price; ?>" data-short="<? echo $base->coolers->cooler[3]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/ICE-BLADE-PRO-V2.0.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Кулер DeepСool ICE BLADE PRO V2.0</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[5]->price; ?>" data-short="<? echo $base->coolers->cooler[5]->short; ?>"><input name="cooler" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/GameMax-Iceberg-240.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Система водяного охлаждения GameMax Iceberg 240</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
										<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[10]->price; ?>" data-short="<? echo $base->videocards->videocard[10]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[11]->price; ?>" data-short="<? echo $base->videocards->videocard[11]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label video_label_outer" data-price="<? echo $base->videocards->videocard[12]->price; ?>" data-short="<? echo $base->videocards->videocard[12]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<!-- Блок видеокарт -->
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video active" style="display:block">
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[14]->price; ?>" data-short="<? echo $base->videocards->videocard[14]->short; ?>"><input name="videocard" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label subactive_video" data-price="<? echo $base->videocards->videocard[15]->price; ?>" data-short="<? echo $base->videocards->videocard[15]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video ">
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[16]->price; ?>" data-short="<? echo $base->videocards->videocard[16]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[17]->price; ?>" data-short="<? echo $base->videocards->videocard[17]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video ">
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[18]->price; ?>" data-short="<? echo $base->videocards->videocard[18]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[19]->price; ?>" data-short="<? echo $base->videocards->videocard[19]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video ">
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[22]->price; ?>" data-short="<? echo $base->videocards->videocard[22]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[23]->price; ?>" data-short="<? echo $base->videocards->videocard[23]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block_video">
											...
											<div class="label_dropdown_content_video ">
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[24]->price; ?>" data-short="<? echo $base->videocards->videocard[24]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label videocard_label video_double_label " data-price="<? echo $base->videocards->videocard[25]->price; ?>" data-short="<? echo $base->videocards->videocard[25]->short; ?>"><input name="videocard" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
									...
									<div class="tab_labels_container">
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[4]->price; ?>" data-short="<? echo $base->rams->ram[4]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[6]->price; ?>" data-short="<? echo $base->rams->ram[6]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[8]->price; ?>" data-short="<? echo $base->rams->ram[8]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[9]->price; ?>" data-short="<? echo $base->rams->ram[9]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[10]->price; ?>" data-short="<? echo $base->rams->ram[10]->short; ?>"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[12]->price; ?>" data-short="<? echo $base->rams->ram[12]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
								...
								<div class="tabs_fps_info">
									...
									<div class="tabs_fps_scale_block">
										<div class="tabs_fps_scale_block_inner">
											<div class="fps_title">Full HD</div>
											<div class="fps_scale">
												<div class="fps_scale_filler filler_green" style="background-color:<? echo $base->computers->comp[1]->games->game[5]->color[1]; ?>; width:<? echo $base->computers->comp[1]->games->game[5]->percent[1]; ?>%;"></div>
											</div>
										</div>
										<div class="tabs_fps_scale_block_inner">

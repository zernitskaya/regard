...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › <span class="product_page_name">игровой компьютер GRIFFIN POWER</span>
		</div>
	</div>
				...
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
							...
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									<div class="side_mini_photo active">
										<img src="http://xn--80afeb8cd.com/new/img/210.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/242.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/216.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/266.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/224.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/220.jpg">
									</div>
									<div class="side_mini_photo">
										<img src="http://xn--80afeb8cd.com/new/img/418.jpg">
									</div>
									<div class="side_mini_photo">
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="http://xn--80afeb8cd.com/new/img/210.jpg" class="main_photo_image">
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[8]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
2 ядра, 4 потока, 3МБ кэш, частота процессора - 3.90ГГц.
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[11]->price; ?>" data-short="<? echo $base->videocards->videocard[11]->short; ?>"><input name="videocard" type="radio"  checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[8]->price; ?>" data-short="<? echo $base->videocards->videocard[8]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AMD-Radeon-RX-570.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon RX 570, 4GB GDDR5</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[12]->price; ?>" data-short="<? echo $base->videocards->videocard[12]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

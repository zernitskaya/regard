		...
		<div class="photo_preview_modal clearfix">
			...
			<div class="photo_preview_side_menu">
				<div class="photo_preview_mini_photo active">
					<img src="img/roundphoto02.jpg.jpg">
				</div>
			...
			<div class="main_photo_preview_main_photo_container">
				...
				<div class="main_photo_preview_video_container">
					<div class="photo_preview_video_innner" id="lightbox_video01">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/S8EOMQ84q80" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video02">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/OuDiF7Jvfog" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
	...
	<div class="header header_product clearfix">
		<div class="product_wrapper">
			<div class="product_header_flex_container clearfix">
				...
				<a href="" class="header_product_nav_menu_item">Главная</a>
				<a href="" class="header_product_nav_menu_item">Купить в рассрочку</a>
				<a href="" class="header_product_nav_menu_item">Доставка и оплата</a>
				<a href="" class="header_product_nav_menu_item">Контакты</a>
		...
		<div class="product_wrapper">
				...
				<div class="product_page_flex_photo_block">
					<div class="new_photo_block">
						...
						<div class="main_photo_container">
							<img id="zoomImage" src="img/210.jpg" class="main_photo_image">
					...
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							<div class="product_page_price_block_outer clearfix">
								...
								<div class="price_block_side_buttons">
									<div class="unpack_block">
										...
										<div class="unpack_text">400 грн за<br>распаковку</div>
									</div>
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span class="comments_num_container"></span> отзывов</a>
							...
							<div class="product_short_info">
								<span>Видеокарта <?=$base->videocards->videocard[0]->short;?></span> / <span>Оперативная память <?=$base->rams->ram[0]->short;?></span> / <span>Видеокарта <?=$base->videocards->videocard[0]->short;?></span> / <span>Оперативная память <?=$base->rams->ram[0]->short;?></span> / <span>Видеокарта <?=$base->videocards->videocard[0]->short;?></span> 
							</div>
						</div>
			...
			<div class="tabs_block">
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы и вопросы
						<div class="tab_btn_inner">
							<span class="comments_num_container"></span>
						</div>
					</div>
				</div>
					...
					<div class="tab_content_inner" id="tab_conf_content">
						<div class="accordion product_accordion">
							<div class="accordion_block super_offer_block">
									<div class="accordion_btn_title">Ограниченное по времени предложение</div>
							...
							<div class="accordion_block" id="accordion_blocks">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label comp_label new" data-price="<? echo $base->corpuses->corpus[0]->price; ?>"><input name="comp" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
												<img src="img/newblock.png">
											...
											<div class="radio_description">
												<div class="radio_description_flex_container">
												<div class="radio_description_title">GreenVision X04, Mid-Tower (42,5 х 17,5 х 41 см)</div>
												</div>
										...
										<label class="radio_label comp_label new" data-price="<? echo $base->corpuses->corpus[1]->price; ?>"><input name="comp" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[2]->price; ?>"><input name="comp" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label comp_label" data-price="<? echo $base->corpuses->corpus[3]->price; ?>"><input name="comp" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label comp_label recommend last_comp_label" data-price="<? echo $base->corpuses->corpus[4]->price; ?>"><input name="comp" type="radio" checked>
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label comp_label recommend" data-price="<? echo $base->corpuses->corpus[4]->price; ?>"><input name="comp" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label fan_label" data-price="<? echo $base->fans->fan[0]->price; ?>"><input name="fan" type="radio" checked>
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label fan_label" data-price="<? echo $base->fans->fan[1]->price; ?>"><input name="fan" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
										...
										<label class="radio_label fan_label recommend" data-price="<? echo $base->fans->fan[1]->price; ?>"><input name="fan" type="radio">
											<div class="radio_circle">
												<div class="radio_circle_inner"></div>
											</div>
											<div class="radio_img">
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											<div class="label_dropdown_btn active">
												...
												<div class="label_dropdown_btn_title">8GB, 2133MHz (Team Elite/GooDRAM)</div>
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[1]->price; ?>"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[2]->price; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[3]->price; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[3]->price; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
						...
						<div class="accordion product_accordion">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->dopvents->dopvent[0]->price; ?>">
											...
											<div class="radio_description">
												<div class="radio_description_flex_container">
												<div class="radio_description_title">Кулер</div>
												</div>
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->mouses->mouse[0]->price; ?>">
											...
											<div class="radio_description">
												<div class="radio_description_flex_container">
												<div class="radio_description_title">Крутой кабель</div>
												</div>
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->mouses->mouse[0]->price; ?>">
											...
											<div class="radio_description">
												<div class="radio_description_flex_container">
												<div class="radio_description_title">Гарнитура</div>
												</div>
							...
							<div class="accordion_block wifi_block">
								...
								<div class="accordion_content new_accordion_content clearfix">
									<div class="new_side_photo_container"></div>
									<div class="new_tab_labels_container">
										<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->mouses->mouse[0]->price; ?>" id="wifiBottom">
											<div class="tabs_checkbox">
												<div class="tabs_checkbox_inner"></div>
											</div>
											<div class="radio_img">
											...
											<div class="radio_description">
												<div class="radio_description_flex_container">
												<div class="radio_description_title">крутой адаптер</div>
												</div>
							...
							<div class="accordion_block software_block">
								...
								<div class="accordion_content new_accordion_content clearfix">
									...
									<div class="new_tab_labels_container">
										...
										<label class="radio_label new_access_label"><input type="checkbox" data-price="<? echo $base->dops->dop[0]->price; ?>" id="micOffBottom">
											<div class="tabs_checkbox">
												<div class="tabs_checkbox_inner"></div>
											</div>
											<div class="radio_img">

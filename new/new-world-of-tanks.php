...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › <span class="product_page_name">игровой компьютер WORLD OF TANKS</span>
		</div>
	</div>
					...
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span class="comments_num_container">131</span> отзывов</a>
				...
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span class="comments_num_container">131</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label videocard_label videocard_label_1" data-price="<? echo $base->videocards->videocard[0]->price; ?>" data-short="<? echo $base->videocards->videocard[0]->short; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[1]->price; ?>" data-short="<? echo $base->videocards->videocard[1]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[2]->price; ?>" data-short="<? echo $base->videocards->videocard[2]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Radeon R7 360 2048Mb GDDR5</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[5]->price; ?>" data-short="<? echo $base->videocards->videocard[5]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon RX 460, 2GB GDDR5</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[3]->price; ?>" data-short="<? echo $base->videocards->videocard[3]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[1]->price; ?>" data-short="<? echo $base->rams->ram[1]->short; ?>"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[2]->price; ?>" data-short="<? echo $base->rams->ram[2]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">

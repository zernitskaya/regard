...
<head>
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/world-of-tanks1.jpg" /> 
	<? 
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.videocard_label_1').on('click', function(){
				$('.block_for_2 input').prop('checked', false)
				$('.block_for_1 input').prop('checked', true)
			})


			$('.videocard_label_2').on('click', function(){
				$('.block_for_1 input').prop('checked', false);
				$('.block_for_2 input').prop('checked', true);
			})
...
<div class="delivery_popup" id="dp">
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">World Of Tanks Edition</div>
		</div>
	</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">World Of Tanks Edition</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<h1 class="product_page_title">Игровой компьютер WORLD OF TANKS EDITION</h1>
			<div class="product_page_flex_container">
				<div class="product_page_flex_inner">
					<div class="main_prod_photo">
						<!-- <div class="cashback">
							...
							<div class="pp_mini_block">Оплата частями<br>
								<img src="img/pp_logo.png" class="pp_mini_block_img"><span>7</span>
								<div class="pp_inner">
									<div class="left_triangle"></div>
									<div class="pp_popup">
						...
						<div class="thumbnail">
							<a href="img/RECARD-65.jpg" class="lightbox_link">
								<img src="img/RECARD-65.jpg">
							</a>
						</div>
					</div>
					<div class="mini_photos_container container_for_10">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-67.jpg" class="lightbox_link">
									<img src="img/RECARD-67.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price"><? echo $base->computers->comp[8]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price new_price_black"><? echo $base->computers->comp[8]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[8]->price; ?>"><input name="proc" type="radio" checked>
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Процессор Intel Celeron G3900 6-го поколения Skylake. Предназначен для недорогих игровых
компьютеров. 2 ядра, 2 потока, 2МБ кэш, частота процессора - 2.80ГГц.
											</div>
											</div>
									...
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[10]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Intel Core i3-7100 3.90 GHz, s1151 Kaby Lake
Процессор Intel® Core™ i3 7-го поколения. Предназначен для среднего уровня игровых компьютеров. 2 ядра, 4 потока, 3МБ кэш, частота процессора - 3.90ГГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label videocard_label videocard_label_1" data-price="<? echo $base->videocards->videocard[0]->price; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label videocard_label_1" data-price="<? echo $base->videocards->videocard[1]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Частота памяти - 5000 МГц. Разрядность шины памяти - 128 бит. (VGA, DVI, HDMI)
									...
									<label class="radio_label videocard_label videocard_label_2" data-price="<? echo $base->videocards->videocard[3]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 7000 МГц.  (DVI-D, DisplayPort, HDMI)
									...
									<label class="radio_label videocard_label videocard_label_2" data-price="<? echo $base->videocards->videocard[5]->price; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label block_label one_line_label block_for_1" data-price="<? echo $base->blocks->block[1]->price; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Тихий надежный блок питания мощностью 400Вт. Использовать с видеокартой GT 730.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label block_label one_line_label block_for_2" data-price="<? echo $base->blocks->block[0]->price; ?>"><input name="block" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

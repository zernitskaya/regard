...
<head>
	...
	<meta property="og:image"  content="http://xn--80afeb8cd.com/img/zeus-evo1.jpg" /> 
	<? 
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('.proc_label_1').on('click', function(){
				$('.videocard_label').css('display', 'none')
				$('.videocard_label_for_1').css('display', 'block')
				$('.videocard_label_for_2 input').prop('checked', false)
				$('.videocard_label_for_3 input').prop('checked', false)
				$('.videocard_label_for_1 input').prop('checked', true)
			})


			$('.proc_label_2').on('click', function(){
				$('.videocard_label').css('display', 'none');
				$('.videocard_label_for_2').css('display', 'block');
				$('.videocard_label_for_1 input').prop('checked', false);
				$('.videocard_label_for_3 input').prop('checked', false);
				$('.videocard_label_for_2 input').prop('checked', true);
			})


			$('.proc_label_3').on('click', function(){
				$('.videocard_label').css('display', 'none');
				$('.videocard_label_for_3').css('display', 'block');
				$('.videocard_label_for_2 input').prop('checked', false);
				$('.videocard_label_for_1 input').prop('checked', false);
				$('.videocard_label_for_3 input').prop('checked', true);
			})
...
<body>
	...
	<div class="bg_modal privat_prod_modal">
		<div class="modal_inner privat_prod_inner">
			<div class="mod_close"></div>
			<h2 style="margin-bottom:40px;">Воспользуйтесь мгновенной рассрочкой от ПриватБанка</h2>
...
<div class="delivery_popup" id="dp">
		...
		<div class="product_wrapper">
			<div class="product_header_flex_container">
				...
				<div class="header_computer_link_flex">
					<a href="back-to-school.html" class="header_computer_link">
						<div class="header_computer_link_title">Back to School</div>
						<div class="header_computer_link_price"><? echo $base->computers->comp[7]->price; ?> грн</div>
					</a>
					<a href="world-of-tanks.html" class="header_computer_link">
						<div class="header_computer_link_title">World of Tanks</div>
						<div class="header_computer_link_price"><? echo $base->computers->comp[8]->price; ?> грн</div>
					</a>
					<a href="dominator-ultra.html" class="header_computer_link">
						<div class="header_computer_link_title">Dominator Ultra</div>
						<div class="header_computer_link_price"><? echo $base->computers->comp[3]->price; ?> грн</div>
					</a>
				</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Zeus Evo</span>
		</div>
	</div>
			...
			<div class="product_page_flex_container">
				<div class="product_page_flex_inner">
					<div class="main_prod_photo">
						<!-- <div class="cashback">
							...
							<div class="lider_prod"><span style="font-size:13px;">лидер</span><br>продаж</div>
							<div class="pp_mini_block">Оплата частями<br>
								<img src="img/pp_logo.png" class="pp_mini_block_img"><span>3</span>
								<div class="pp_inner">
									<div class="left_triangle"></div>
									<div class="pp_popup">
						...
						<div class="thumbnail">
							<a href="img/RECARD-51.jpg" class="lightbox_link">
								<img src="img/RECARD-51.jpg">
							</a>
						</div>
					</div>
					<div class="mini_photos_container container_for_10">
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-42.jpg" class="lightbox_link">
									<img src="img/RECARD-42.jpg">
								</a>
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-54.jpg" class="lightbox_link">
									<img src="img/RECARD-54.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-60.jpg" class="lightbox_link">
									<img src="img/RECARD-60.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-68.jpg" class="lightbox_link">
									<img src="img/RECARD-68.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
						...
						<div class="mini_photo">
							<div class="thumbnail">
								<a href="img/RECARD-152.jpg" class="lightbox_link">
									<img src="img/RECARD-152.jpg">
								</a>	
							</div>
						</div>
						<div class="mini_photo">
				...
				<div class="product_page_flex_inner">
					...
					<div class="product_page_price_block">
						<div class="old_price" style="display:none;"><? echo $base->computers->comp[6]->oldprice; ?>
							<div class="old_price_inner"></div>
						</div>
						<div class="new_price new_price_black"><? echo $base->computers->comp[6]->price; ?> <span>грн</span></div>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[0]->price; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Предназначен для недорогих компьютеров. 2 ядра. Базовая частота процессора - 3.00ГГц. Максимальная частота в турбо режиме - 3.20ГГц. Тепловыделение - 65W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[1]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. 2 ядра, 4МБ кэш L2. Базовая частота
процессора - 3.10ГГц. Максимальная частота в турбо режиме - 3.80ГГц. Тепловыделение - 65W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_3" data-price="<? echo $base->processors->cpu[2]->price; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Предназначен для игровых компьютеров. Базовая частота процессора - 3.90ГГц.
Максимальная частота в турбо режиме - 4.10ГГц. Тепловыделение - 65W
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label videocard_label videocard_label_for_2" data-price="0"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="img/radeon.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon HD7540D, 2GB (128bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Видеокарта поддерживает DirectX 11, OpenCL 1.1, OpenGL 3.2 и 2.1. Разрядность шины памяти - 128 бит. (D-Sub, DVI-D, HDMI)
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label videocard_label videocard_label_for_1" data-price="0" style="display:none"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon HD7480D, 2GB (128bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Видеокарта поддерживает DirectX 11, OpenCL 1.1, OpenGL 3.2 и 2.1. Разрядность шины памяти - 128 бит. (D-Sub, DVI-D, HDMI)
											</div>
											</div>
									...
									<label class="radio_label videocard_label videocard_label_for_3" data-price="0" style="display:none"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon HD8470D, 2GB (128bit)</div>
											<div class="radio_description_text">
												Игровая видеокарта начального уровня. Видеокарта поддерживает DirectX 11, OpenCL 1.1, OpenGL 3.2 и 2.1. Разрядность шины памяти - 128 бит. (D-Sub, DVI-D, HDMI)
											</div>
											</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[0]->price; ?>"><input name="cooler" type="radio" checked>
										...
										<div class="radio_img">
											<img src="img/cooler4.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">Боксовый кулер процессора</div>
											<div class="radio_description_text">
												Стандартный алюминиевый радиатор с квадратным основанием, к которому прикреплены четыре секции ребер, и низкопрофильный вентилятор. Расчитан на 65-ваттные процессоры AMD.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								<div class="accordion_btn_title">Память DDR3</div>
								<div class="accordion_btn active ddr_btn"></div>
								<div class="accordion_content">
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[5]->price; ?>"><input name="ddr" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">4GB, 1600MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Один модуль на 4ГБ сверхнадежной памяти DDR3 с частотой 1600 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[6]->price; ?>"><input name="ddr" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8GB, 1600MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Один модуль на 8ГБ сверхнадежной памяти DDR3 с частотой 1600 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									...
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[7]->price; ?>"><input name="ddr" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">8GB, (2x4GB) 1600MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Комплект из 2-х модулей по 4ГБ сверхнадежной памяти DDR3 с частотой 1600 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									...
									<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[8]->price; ?>"><input name="ddr" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">16GB, (2x8GB) 1600MHz (Team Elite/GooDRAM)</div>
											<div class="radio_description_text">
												Комплект из 2-х модулей по 8ГБ сверхнадежной памяти DDR3 с частотой 1600 МГц.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[1]->price; ?>"><input name="hdd" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Высокопроизводительный, экологичный и тихий диск. Интерфейс SATA 6 Гбит/с позволяет достичь максимальной производительности при работе с данными.
									...
									<label class="radio_label hdd_label" data-price="<? echo $base->hdds->hdd[3]->price; ?>"><input name="hdd" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label mat_label" data-price="<? echo $base->materinkas->materinka[1]->price; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label block_label one_line_label" data-price="<? echo $base->blocks->block[1]->price; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											...
											<div class="radio_description_text">
												Недорогое и эффективное решение, предназначен для недорогих игровых компьютеров.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
...
Имеет 24x скорости записи DVD + R и 48x скоростей записи CD-R.
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label comp_label one_line_label" data-price="<? echo $base->corpuses->corpus[0]->price; ?>"><input name="comp" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">

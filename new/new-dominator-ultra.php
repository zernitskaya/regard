			...
			<div class="main_photo_preview_main_photo_container">
				...
				<div class="main_photo_preview_video_container">
					<div class="photo_preview_video_innner" id="lightbox_video01">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Eudwqwg8AwM" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video02">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/9Rk9KOOpHnM" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video03">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/oAL8IdgcfFM" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video04">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/NWjs3FRlf_E" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video05">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/lwVoduYg30w" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="photo_preview_video_innner" id="lightbox_video06">
						<iframe width="100%" height="100%" src="https://www.youtube.com/embed/0c_wHGCd9WQ" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
...
<div class="delivery_popup" id="dp">
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> › <span class="product_page_name">игровой компьютер DOMINATOR ULTRA</span>
		</div>
	</div>
					...
					<div class="new_photo_block">
						<div class="side_photo_container_outer">
							<div class="side_photo_container">
								<div class="side_photo_container_inner">
									...
									<div class="side_mini_video" data-video="video06">
										<img src="img/video-preview.png">
									</div>
								</div>
							</div>
						...
						<div class="main_photo_container">
							...
							<div class="main_video_container">
								...
								<div class="video_innner" id="video06">
									<iframe width="100%" height="100%" src="https://www.youtube.com/embed/0c_wHGCd9WQ" frameborder="0" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					...
					<div class="product_page_flex_info_block_inner clearfix">
						<div class="product_page_flex_price">
							...
							<div class="stars_block clearfix">
								...
								<a href="#tabsNavBar" class="comments_num scrolltoTop"><span class="comments_num_container">64</span> отзывов</a>
				...
				<div class="tabs_navbar_fixed" id="tabsNavBar">
					...
					<div id="tfo" data="tab_comments" class="tabs_fixed_btn">Отзывы <span class="ques_hid">и вопросы</span>
						<div class="tab_btn_inner">
							<span class="comments_num_container">64</span>
						</div>
					</div>
				</div>
						...
						<div class="accordion product_accordion">
							...
							<div class="accordion_block clearfix" id="accordion_proc">
								...
								<div class="accordion_content clearfix" style="display:block">
									...
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[6]->price; ?>" data-short="<? echo $base->processors->cpu[6]->short; ?>"><input name="proc" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Athlon X4 840 3,8GHz, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_1" data-price="<? echo $base->processors->cpu[7]->price; ?>" data-short="<? echo $base->processors->cpu[7]->short; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Athlon X4 860K 4,0GHz, sFM2+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[18]->price; ?>" data-short="<? echo $base->processors->cpu[18]->short; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-4300 3,8GHz, sAM3+
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									...
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[19]->price; ?>" data-short="<? echo $base->processors->cpu[19]->short; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-6300 4,1GHz, sAM3+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label proc_label_2" data-price="<? echo $base->processors->cpu[20]->price; ?>" data-short="<? echo $base->processors->cpu[20]->short; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD FX-8300 4,2GHz, sAM3+</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block" id="accordion_video">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[4]->price; ?>" data-short="<? echo $base->videocards->videocard[4]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AMD Radeon RX 550, 2GB GDDR5</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[3]->price; ?>" data-short="<? echo $base->videocards->videocard[3]->short; ?>"><input name="videocard" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label videocard_label" data-price="<? echo $base->videocards->videocard[9]->price; ?>" data-short="<? echo $base->videocards->videocard[9]->short; ?>"><input name="videocard" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<div class="tab_labels_container">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[21]->price; ?>" data-short="<? echo $base->rams->ram[21]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[22]->price; ?>" data-short="<? echo $base->rams->ram[22]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content active" style="display:block">
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[23]->price; ?>" data-short="<? echo $base->rams->ram[23]->short; ?>"><input name="ddr" type="radio" checked>
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label subactive" data-price="<? echo $base->rams->ram[24]->price; ?>" data-short="<? echo $base->rams->ram[24]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[25]->price; ?>" data-short="<? echo $base->rams->ram[25]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[26]->price; ?>" data-short="<? echo $base->rams->ram[26]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
										...
										<div class="label_dropdown_block">
											...
											<div class="label_dropdown_content">
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[27]->price; ?>" data-short="<? echo $base->rams->ram[27]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
												...
												<label class="radio_label ddr_label one_line_label" data-price="<? echo $base->rams->ram[28]->price; ?>" data-short="<? echo $base->rams->ram[28]->short; ?>"><input name="ddr" type="radio">
													<div class="radio_circle">
														<div class="radio_circle_inner"></div>
													</div>
													<div class="radio_img">
							...
							<div class="accordion_block" id="accordion_motherboard">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label mat_label mat_for_1" data-price="<? echo $base->materinkas->materinka[1]->price; ?>" style="display:none" data-short="<? echo $base->materinkas->materinka[1]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label mat_label mat_for_2_init mat_for_2" data-price="<? echo $base->materinkas->materinka[2]->price; ?>" data-short="<? echo $base->materinkas->materinka[2]->short; ?>"><input name="mat" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
									...
									<label class="radio_label mat_label mat_for_2" data-price="<? echo $base->materinkas->materinka[6]->price; ?>" data-short="<? echo $base->materinkas->materinka[6]->short; ?>"><input name="mat" type="radio">
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
											<img src="http://xn--80afeb8cd.com/newimg/AM3+-AMD-970980G.png">
										</div>
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">AM3+ (AMD 970/980G, PCI-Ex16, 4 x DDR3, MicroATX)</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
							...
							<div class="accordion_block">
								...
								<div class="accordion_content clearfix">
									...
									<div class="tab_labels_container">
									<label class="radio_label block_label one_line_label" data-price="<? echo $base->blocks->block[3]->price; ?>" data-short="<? echo $base->blocks->block[3]->short; ?>"><input name="block" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
										...
										<div class="radio_description">
											<div class="radio_description_flex_container">
											<div class="radio_description_title">450W LogicPower</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>

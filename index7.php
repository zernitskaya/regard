...
для видеомонтажа</h2>
	...
	<div class="products_block" id="computers">
		<div class="wrapper">
			<h2>Идеальные игровые компьютеры</h2>
			...
			<div class="products_container">
				...
				<a href="raven-x-treme.html" target="_blank">
					<div class="blue_part">
						<img class="product_block_img" src="img/viper1080.png">
					</div>
				...
				<a href="amd-ryzen.html" target="_blank">
					<div class="blue_part">
						<img class="product_block_img" src="img/devastator2.png">
					</div>
					<div class="white_part">
				...
				<div class="product_block">
					<!-- <div class="cashback">
							...
							<div class="pp_mini_block">Оплата частями<br>
								<img src="img/pp_logo.jpg" class="pp_mini_block_img"><span>4</span>
								<div class="pp_inner">
									<div class="left_triangle"></div>
									<div class="pp_popup">
				...
				<a href="pro-gamer-3000.html" target="_blank">
					<div class="blue_part">
						<img class="product_block_img" src="img/progamer1050.png">
				...
				<a href="hellcat-pro.html" target="_blank">
					<div class="blue_part">
						<img class="product_block_img" src="img/hellcat480.png">
					</div>
					<div class="white_part">
						<div class="product_title"><span>Hellcat Pro</span></div>
						<div class="product_subtitle">FPS FullHD 1920x1080 High</div>
						<div class="fps_container clearfix">
							<div class="fps_game">Doom 4</div>
							<div class="fps_scale">
								<div class="fps_scale_filler fps_scale_filler_2" style="width:<? echo $base->computers->comp[4]->games->game[0]->percent[2]; ?>%; background-color: <? echo $base->computers->comp[4]->games->game[0]->color[2]; ?>"></div>
							</div>
							<div class="fps_num fps_num_2" style="color: <? echo $base->computers->comp[4]->games->game[0]->color[2]; ?>"><? echo $base->computers->comp[4]->games->game[0]->fps; ?> fps</div>
						</div>
						<div class="fps_container clearfix">
							<div class="fps_game">Overwatch</div>
							<div class="fps_scale">
								<div class="fps_scale_filler fps_scale_filler_2" style="width:<? echo $base->computers->comp[4]->games->game[5]->percent[2]; ?>%; background-color: <? echo $base->computers->comp[4]->games->game[5]->color[2]; ?>"></div>
							</div>
							<div class="fps_num fps_num_2" style="color: <? echo $base->computers->comp[4]->games->game[5]->color[2]; ?>"><? echo $base->computers->comp[4]->games->game[5]->fps; ?> fps</div>
						</div>
						<div class="fps_container clearfix">
							<div class="fps_game">Battlefield 1</div>
							<div class="fps_scale">
								<div class="fps_scale_filler fps_scale_filler_2" style="width:<? echo $base->computers->comp[4]->games->game[1]->percent[2]; ?>%; background-color: <? echo $base->computers->comp[4]->games->game[1]->color[2]; ?>"></div>
							</div>
							<div class="fps_num fps_num_2" style="color: <? echo $base->computers->comp[4]->games->game[1]->color[2]; ?>"><? echo $base->computers->comp[4]->games->game[1]->fps; ?> fps</div>
						</div>
						<div class="fps_container clearfix">
							<div class="fps_game">For honor</div>
							<div class="fps_scale">
								<div class="fps_scale_filler fps_scale_filler_2" style="width:<? echo $base->computers->comp[4]->games->game[2]->percent[2]; ?>%; background-color: <? echo $base->computers->comp[4]->games->game[2]->color[2]; ?>"></div>
							</div>
							<div class="fps_num fps_num_2" style="color: <? echo $base->computers->comp[4]->games->game[2]->color[2]; ?>"><? echo $base->computers->comp[4]->games->game[2]->fps; ?> fps</div>
						</div>
						<div class="fps_container clearfix">
							<div class="fps_game">GTA 5</div>
							<div class="fps_scale">
								<div class="fps_scale_filler fps_scale_filler_2" style="width:<? echo $base->computers->comp[4]->games->game[3]->percent[2]; ?>%; background-color: <? echo $base->computers->comp[4]->games->game[3]->color[2]; ?>"></div>
							</div>
							<div class="fps_num fps_num_2" style="color: <? echo $base->computers->comp[4]->games->game[3]->color[2]; ?>"><? echo $base->computers->comp[4]->games->game[3]->fps; ?> fps</div>
						</div>
						<table>
							<tr>
								<td>FX-6300 6 ЯДЕР</td>
								<td>GTX 1050 2GB</td>
							</tr>
							<tr>
								<td>DDR3 8GB</td>
						...
						<div class="btn_container clearfix">
							<div class="price_block">
								<div class="old_price_main_page"><? echo $base->computers->comp[4]->oldprice; ?></div>
								<div class="new_price_main_page"><? echo $base->computers->comp[4]->price; ?></div>
							</div>
							<div class="product_link"><img src="img/configurator.svg">Изменить</div>
						</div>
					</div>
				...
				<a href="dominator-ultra.html" target="_blank">
					<div class="blue_part">
						<img class="product_block_img" src="img/dominator740.png">
						<!-- <div class="top_sale">Топ Продаж</div> -->
					</div>
					<div class="white_part">
				...
				<a href="back-to-school.html" target="_blank">
					...
					<div class="white_part">
						...
						<div class="btn_container clearfix">
							<div class="price_block single_priceblock">
								<div class="old_price_main_page" style="display:none"><? echo $base->computers->comp[7]->oldprice; ?></div>
								<div class="new_price_main_page new_single_price"><? echo $base->computers->comp[7]->price; ?><span>грн</span></div>
							</div>
							<div class="product_link"><img src="img/configurator.svg">Изменить</div>
						</div>
					</div>
				...
				<a href="zeus-evo.html" target="_blank">
					...
					<div class="white_part">
						...
						<div class="btn_container clearfix">
							<div class="price_block single_priceblock">
								<div class="old_price_main_page" style="display:none"><? echo $base->computers->comp[6]->oldprice; ?></div>
								<div class="new_price_main_page new_single_price"><? echo $base->computers->comp[6]->price; ?><span>грн</span></div>
							</div>
							<div class="product_link"><img src="img/configurator.svg">Изменить</div>
						</div>
					</div>

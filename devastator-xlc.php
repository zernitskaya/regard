...
<body>
	...
	<div class="bottom_price_nav">
		<div class="product_wrapper clearfix">
			...
			<div class="bottom_computer_title">Devastator XLC</div>
		</div>
	</div>
	...
	<div class="sitemap">
		<div class="product_wrapper">
			<a href="index.html">Главная</a> / <span class="product_page_name">Devastator XLC</span>
		</div>
	</div>
	<div class="product_page_main_block">
		<div class="product_wrapper">
			<h1 class="product_page_title">Игровой компьютер DEVASTATOR XLC</h1>
						...
						<div class="accordion product_accordion">
							<div class="accordion_block">
								...
								<div class="accordion_content" style="display:block">
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[12]->price; ?>"><input name="proc" type="radio">
										...
										<div class="radio_description">
											...
											<div class="radio_description_title">Intel Core i7-6700 4.00 GHz, s1151
											</div>
											<div class="radio_description_text">
												Процессор Intel® Core™ i7 6-го поколения. Предназначен для мощных игровых систем. 4 ядра, 8 потоков, 8МБ кэш, частота процессора от 3.40ГГц. до 4.00ГГц. Тепловыделение 65W.
											</div>
											</div>
											<div class="radio_price"></div>
										</div>
									</label>
									<label class="radio_label proc_label" data-price="<? echo $base->processors->cpu[16]->price; ?>"><input name="proc" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
Поддерживает DirectX 12, OpenGL 4.5 Частота памяти - 8008 МГц.  (DVI-D, 2 x DisplayPort, 2 x HDMI)
							...
							<div class="accordion_block">
								...
								<div class="accordion_content">
									<label class="radio_label cooler_label" data-price="<? echo $base->coolers->cooler[2]->price; ?>"><input name="cooler" type="radio" checked>
										<div class="radio_circle">
											<div class="radio_circle_inner"></div>
										</div>
										<div class="radio_img">
...
<div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,moimir,gplus,viber,skype,telegram"></div>
				...
				<a href="devastator-xlc.html" class="computers_footer_link">
					Devastator xlc
